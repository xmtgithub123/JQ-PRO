...
namespace ASP
{
    ...
    #line 1 "..\..\Views\DesExch\ExchTaskList.cshtml"
    using JQ.Web;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/DesExch/ExchTaskList.cshtml")]
    public partial class _Views_DesExch_ExchTaskList_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_DesExch_ExchTaskList_cshtml()
        {
        }
...
WriteLiteral(">\r\n    var requestUrl = \'");
            ...
            #line 4 "..\..\Views\DesExch\ExchTaskList.cshtml"
...
WriteLiteral("?SpecId=");
            ...
            #line 4 "..\..\Views\DesExch\ExchTaskList.cshtml"
                                                                                           Write(Request.Params["ExchSpecID"]);
...
"          if (row.count > 0) {\r\n\r\n                        //if(row.recCount>0)\r\n" +
"                        //{\r\n                        //    text = \"重提\";\r\n\r\n     " +
"                   //    return \'<a btn class=\"easyui-linkbutton\" onclick=\"ReUse" +
"Exch(\' + row.Id + \')\">\' + text + \'</a>\';\r\n\r\n                        //}\r\n       " +
"                 //else\r\n                        //{\r\n                        //" +
"    text = \"查看\";\r\n                        //}\r\n                        return \'<" +
"a btn class=\"easyui-linkbutton\" onclick=\"ReUseExch(\' + row.Id + \')\">重提</a>\' +\r\n " +
"                           \'<a btn class=\"easyui-linkbutton\" onclick=\"ExchApprov" +
"e(\' + row.Id + \')\">查看</a>\';;\r\n\r\n                    }\r\n                    else " +
"{\r\n                        text = \"提资\";\r\n                    }\r\n                " +
"    return \'<a btn class=\"easyui-linkbutton\" onclick=\"ExchApprove(\' + row.Id + \'" +
")\">\' + text + \'</a>\';\r\n                }\r\n            },\r\n            {\r\n       " +
"         field: \"process\", title: \"流程进度\", align: \"center\", halign: \"center\", wid" +
"th: 90,\r\n                formatter: JQ.Flow.showFlowProgress(\"DesExchGrid\", \"Des" +
...
"     }\r\n                });\r\n        }\r\n    });\r\n\r\n\r\n    function getProgress(gr" +
"id, refTable, refID, url) {\r\n        if (!JQ.Flow._progress) {\r\n            JQ.F" +
"low._progress = {\r\n            };\r\n        }\r\n        JQ.Flow._progress[\"$flow\" " +
...
"url: \'");
            ...
            #line 190 "..\..\Views\DesExch\ExchTaskList.cshtml"
...
WriteLiteral(@"',
    ...
    function ReUseExch(ExchId) {
        JQ.dialog.dialog({
            ...
            #line 205 "..\..\Views\DesExch\ExchTaskList.cshtml"
...
WriteLiteral(@"',
    ...
    function AddSpecExchPlan() {
        JQ.dialog.dialog({
            ...
            #line 233 "..\..\Views\DesExch\ExchTaskList.cshtml"
...
WriteLiteral(" onclick=\"ClosePage();\"");
