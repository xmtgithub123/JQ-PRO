...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/DesTask/TaskAttach.cshtml")]
    public partial class _Views_DesTask_TaskAttach_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_DesTask_TaskAttach_cshtml()
        {
        }
...
WriteAttribute("href", Tuple.Create(" href=\"", 7), Tuple.Create("\"", 64)
            ...
            #line 2 "..\..\Views\DesTask\TaskAttach.cshtml"
...
WriteLiteral(" id=\"TaskAttach_files\"");

WriteLiteral("></table>\r\n        <div");

WriteLiteral(" id=\"TaskAttach_rigthMenu\"");

WriteLiteral(" data-options=\"onClick:TaskAttach_rigthMenuHandler\"");
...
WriteAttribute("src", Tuple.Create(" src=\"", 2196), Tuple.Create("\"", 2248)
            
            #line 69 "..\..\Views\DesTask\TaskAttach.cshtml"
, Tuple.Create(Tuple.Create("", 2202), Tuple.Create<System.Object, System.Int32>(Url.Content("~/Scripts/uploader/upload.js")
...
WriteAttribute("src", Tuple.Create(" src=\"", 2291), Tuple.Create("\"", 2350)
            
            #line 70 "..\..\Views\DesTask\TaskAttach.cshtml"
, Tuple.Create(Tuple.Create("", 2297), Tuple.Create<System.Object, System.Int32>(Url.Content("~/Scripts/uploader/jq.taskUpload.js")
...
WriteAttribute("src", Tuple.Create(" src=\"", 2393), Tuple.Create("\"", 2440)
            
            #line 71 "..\..\Views\DesTask\TaskAttach.cshtml"
, Tuple.Create(Tuple.Create("", 2399), Tuple.Create<System.Object, System.Int32>(Url.Content("~/Scripts/JQ/DesFlow.js")
...
"signUpload.requireurl = \'");

            
            #line 115 "..\..\Views\DesTask\TaskAttach.cshtml"
...
WriteLiteral("?TaskId=\'+");
            ...
            #line default
            #line hidden
WriteLiteral(";\r\n        _TaskAttachDesignUpload.downloadUrl = \"");

            
            #line 116 "..\..\Views\DesTask\TaskAttach.cshtml"
                                           Write(Url.Action("Download", "ProcessFile", new { @area = "Core" }));

            
            #line default
            #line hidden
WriteLiteral("\";\r\n        _TaskAttachDesignUpload.batchDownloadUrl = \"");

            
            #line 117 "..\..\Views\DesTask\TaskAttach.cshtml"
                                                Write(Url.Action("BatchDownload", "ProcessFile", new { @area = "Core" }));

            
            #line default
            #line hidden
WriteLiteral("\";\r\n        _TaskAttachDesignUpload.flash_swf_url=\"");

            
            #line 118 "..\..\Views\DesTask\TaskAttach.cshtml"
                                           Write(Url.Content("~/Scripts/uploader/upload.swf"));

            
            #line default
            #line hidden
WriteLiteral("\";\r\n        _TaskAttachDesignUpload.silverlight_xap_url= \"");

            
            #line 119 "..\..\Views\DesTask\TaskAttach.cshtml"
...
"\"</strong></div>\";\r\n                    }else {\r\n                        FileNam" +
"e=\"<div><a href=\\\"\"+_TaskAttachDesignUpload.buildDownloadUrl(row.AttachID, { typ" +
"e: \'attach\' })+\"\\\" target=\'_blank\' >\"+value+\"</a>\";\r\n                        Fil" +
"eName+=\"</div>\";\r\n                    }\r\n                    return FileName;\r\n " +
"               } },\r\n                { title: \'校审流程\', field: \'12\', width: 600, a" +
"lign: \'left\',formatter:function (value,row,index) {\r\n                    return " +
"\"<div class=\\\"swipe\\\"><div id=\\\"FlowNode_\"+row.AttachID+\"\\\" class=\\\"approve-prog" +
"ress\\\"></div></div>\"\r\n                } },\r\n                { title: \"版本\", field" +
": \"AttachVer\", width: 50, align: \"center\", halign: \"center\",formatter:function (" +
"value, row,index) {\r\n                    if(row.AttachExt==\".\"){\r\n              " +
"          return \"\";\r\n                    }else {\r\n\r\n                        ret" +
"urn value;\r\n                    }\r\n                } },\r\n                {\r\n    " +
"                title: \"大小\", field: \"AttachSize\", width: 76, align: \"center\", ha" +
"lign: \"center\", formatter: function (value, row,index) {\r\n                      " +
"  if(row.AttachExt==\".\"){\r\n                            return \"\";\r\n             " +
"           }else {\r\n                            return JQ.tools.getFileSizeText(" +
"value);\r\n                        }\r\n                    }},\r\n                {\r\n" +
"                    title: \"修改时间\", field: \"AttachDateChange\", width: 120, align:" +
" \"center\", halign: \"center\", formatter: function (value, rowData,index) {\r\n     " +
"                   return JQ.tools.DateTimeFormatterByT(rowData.AttachDateChange" +
");\r\n                    }\r\n                },\r\n                {\r\n              " +
"      title: \"上传日期\", field: \"AttachDateUpload\", width: 90, align: \"center\", hali" +
"gn: \"center\", formatter: function (value, rowData,index) {\r\n                    " +
"    return JQ.tools.DateTimeFormatterByT(rowData.AttachDateUpload);\r\n           " +
"         }\r\n                }\r\n            ]],\r\n            onLoadSuccess:functi" +
"on (row,data) {\r\n                if (data.total>0) {\r\n                    $.each" +
"(data.rows,function (i,e) {\r\n                        e.__checkbox = true;\r\n     " +
"                   var jsonNode = [];\r\n                        if (e.AttachFlowN" +
"odeJson!=\"\") {\r\n                            jsonNode=JSON.parse(e.AttachFlowNode" +
"Json).root.item;\r\n\r\n                            if (e.AttachExt!=\".\") {\r\n       " +
"                         var $table=$(\"div[id=\'FlowNode_\"+e.AttachID+\"\']\", $(\"#T" +
...
WriteLiteral(@"?AttachID=' + data.AttachID + '&AttachVer=' + data.AttachVer,
            ...
            #line 214 "..\..\Views\DesTask\TaskAttach.cshtml"
...
WriteLiteral(@"?AttachID=' + data.AttachID,
            ...
            #line 222 "..\..\Views\DesTask\TaskAttach.cshtml"
