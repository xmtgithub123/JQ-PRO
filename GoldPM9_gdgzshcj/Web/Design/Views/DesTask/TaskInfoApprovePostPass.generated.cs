...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/DesTask/TaskInfoApprovePostPass.cshtml")]
    public partial class _Views_DesTask_TaskInfoApprovePostPass_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_DesTask_TaskInfoApprovePostPass_cshtml()
        {
        }
...
WriteAttribute("src", Tuple.Create(" src=\"", 2062), Tuple.Create("\"", 2107)
            ...
            #line 72 "..\..\Views\DesTask\TaskInfoApprovePostPass.cshtml"
...
WriteLiteral(" id=\"TaskInfoApprovePostPass\"");
...
WriteLiteral(" id=\"TaskInfoApprovePostPass_files\"");
...
WriteLiteral(">\r\n                    $(function () {\r\n                        $(\'#TaskInfoAppro" +
"vePostPass_files\').treegrid({\r\n                            url: \'");

            
            #line 98 "..\..\Views\DesTask\TaskInfoApprovePostPass.cshtml"
...
WriteLiteral(@",
            ...
            #line 106 "..\..\Views\DesTask\TaskInfoApprovePostPass.cshtml"
...
"tachName+\"</div>\";\r\n                                    return FileName;\r\n      " +
"                          } },\r\n                                 { title: \'校审流程\'" +
", field: \'FlowNodePass\', width: 600, align: \'left\',formatter:function (value,row" +
",index) {\r\n                                     return \"<div id=\\\"FlowNodePass_\"" +
"+row.AttachID+\"\\\" class=\\\"approve-progress\\\"></div>\"\r\n                          " +
"       } },\r\n                                { title: \"版本\", field: \"AttachVer\", " +
"width: 50, align: \"center\", halign: \"center\",formatter:function (value,row,index" +
") {\r\n                                    if(row.AttachExt==\".\"){\r\n              " +
"                          return \"\";\r\n                                    }else " +
"{\r\n                                        return value;\r\n                      " +
"              }\r\n                                } },\r\n                         " +
"       {\r\n                                    title: \"大小\", field: \"AttachSize\", " +
"width: 76, align: \"center\", halign: \"center\", formatter: function (value, row,in" +
"dex) {\r\n                                        if(row.AttachExt==\".\"){\r\n       " +
"                                     return \"\";\r\n                               " +
"         }else {\r\n                                            return JQ.tools.ge" +
"tFileSizeText(value);\r\n                                        }\r\n              " +
"                      }\r\n                                },\r\n                   " +
"             {\r\n                                    title: \"修改时间\", field: \"Attac" +
"hDateChange\", width: 90, align: \"center\", halign: \"center\", formatter: function " +
"(value, rowData,index) {\r\n                                        return JQ.tool" +
"s.DateTimeFormatterByT(rowData.AttachDateChange);\r\n                             " +
"       }\r\n                                },\r\n                                {\r" +
"\n                                    title: \"上传日期\", field: \"AttachDateUpload\", w" +
"idth: 90, align: \"center\", halign: \"center\", formatter: function (value, rowData" +
",index) {\r\n                                        return JQ.tools.DateTimeForma" +
"tterByT(rowData.AttachDateUpload);\r\n                                    }\r\n     " +
"                           },\r\n                                {\r\n              " +
"                      title: \"操作\", field: \"AttachID\", width: 80, align: \"center\"" +
", halign: \"center\", formatter: function (value, rowData,index) {\r\n              " +
"                          return \"<a id=\\\"btnDel\\\" href=\\\"#\\\" rootID=\"+rowData.A" +
"ttachID+\" >排除</a>  \";\r\n                                    }\r\n                  " +
"              }\r\n                            ]],\r\n                            on" +
"LoadSuccess:function (row,data) {\r\n                                if (data.tota" +
"l>0) {\r\n                                    $.each(data.rows,function (i,e) {\r\n " +
"                                       if (e.AttachExt==\".\") {\r\n                " +
"                            if ( $(\"#TaskInfoApprovePostPass_files\").treegrid(\"g" +
"etChildren\",e.AttachID).length==0) {\r\n                                          " +
"      $(\"#TaskInfoApprovePostPass_files\").treegrid(\"update\",{id:e.AttachID,row:{" +
"iconCls:\"fa-folder\"}});\r\n                                                $(\"span" +
"[class=\'tree-icon tree-file fa-folder\']\").removeClass(\"tree-file\");\r\n           " +
"                                     //$(\"#TaskInfoDiv > .tree-icon,#TaskInfoDiv" +
" > .tree-file,#TaskInfoDiv > .fa-folder\").removeClass(\"tree-file\");\r\n           " +
"                                 }\r\n                                        }els" +
"e {\r\n\r\n                                            var jsonNode= e.AttachFlowNod" +
"eJson == \"\" ? [] : JSON.parse(e.AttachFlowNodeJson).root.item;\r\n                " +
...
"tPass_files\").treegrid(\"getParent\",AttachID);\r\n                            $(\"#T" +
"askInfoApprovePostPass_files\").treegrid(\"remove\",AttachID);\r\n                   " +
"         //判断父节点\r\n                            if (parentNode!=null) {\r\n         " +
"                       if ($(\"#TaskInfoApprovePostPass_files\").treegrid(\"getChil" +
"dren\",parentNode.AttachID).length==0) {\r\n                                    $(\"" +
"#TaskInfoApprovePostPass_files\").treegrid(\"update\", { id: parentNode.AttachID, r" +
"ow: { iconCls: \"fa-folder\" } });\r\n\r\n                                    var pane" +
"l= $(\"#TaskInfoApprovePostPass_files\").treegrid(\"getPanel\");\r\n                  " +
...
"window.top.$(\"#");
            ...
            #line 227 "..\..\Views\DesTask\TaskInfoApprovePostPass.cshtml"
                  Write(ViewBag._DialogId);

            
            #line default
            #line hidden
WriteLiteral("\").dialog(\"close\");\r\n    });\r\n\r\n    $(\"#btnNext\", $(\"#TaskInfoApprovePostPass\"))." +
"click(function () {\r\n\r\n        //判断是否有文件\r\n        var result=false;\r\n        var" +
" rootNode=$(\"#TaskInfoApprovePostPass_files\").treegrid(\"getRoots\");\r\n        if " +
"(rootNode==null||rootNode.length==0) {\r\n            JQ.dialog.show(\"没有可提交的文件！！！\"" +
");\r\n            return false;\r\n        }\r\n        //仅判断是否有文件\r\n        $.each(roo" +
"tNode,function (i,e) {\r\n            if (result) {\r\n                return false;" +
"\r\n            }\r\n            if (e.AttachExt!=\".\") {\r\n                result=tru" +
"e;\r\n                return false;\r\n            }\r\n            var childNodes=$(\"" +
"#TaskInfoApprovePostPass_files\").treegrid(\"getChildren\",e.AttachID);\r\n          " +
...
" addRow.push(e.AttachID);\r\n            var childNodes=$(\"#TaskInfoApprovePostPas" +
"s_files\").treegrid(\"getChildren\",e.AttachID);\r\n            if (childNodes!=null&" +
...
"(\',\'));\r\n                //更新校审 状态\r\n                if (typeof(window[\"FormCheck" +
"Refresh_\" + info.parentid])==\"function\") {\r\n                    window[\"FormChec" +
"kRefresh_\" + info.parentid]();\r\n                }\r\n                if(!PostResul" +
"t)  return false;\r\n            }\r\n\r\n            JQ.tools.ajax({\r\n               " +
" url : \'");

            
            #line 290 "..\..\Views\DesTask\TaskInfoApprovePostPass.cshtml"
                  Write(Url.Action("TaskInfoApproveSavePostPass"));
...
"llBack : function(data) {\r\n                    if (typeof(window.top[\"_DialogCal" +
"lback_");

            
            #line 293 "..\..\Views\DesTask\TaskInfoApprovePostPass.cshtml"
                                                      Write(ViewBag._DialogId);
...
WriteLiteral("\"]) == \"function\") {\r\n                        window.top[\"_DialogCallback_");
            ...
            #line 294 "..\..\Views\DesTask\TaskInfoApprovePostPass.cshtml"
                                               Write(ViewBag._DialogId);
...
WriteLiteral("\"]();\r\n                        window.top.$(\"#");
            ...
            #line 295 "..\..\Views\DesTask\TaskInfoApprovePostPass.cshtml"
                                  Write(ViewBag._DialogId);
