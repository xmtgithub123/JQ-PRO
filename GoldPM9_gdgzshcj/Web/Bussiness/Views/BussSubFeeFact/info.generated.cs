...
namespace ASP
{
    ...
    #line 3 "..\..\Views\BussSubFeeFact\info.cshtml"
    using JQ.Web;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/BussSubFeeFact/info.cshtml")]
    public partial class _Views_BussSubFeeFact_info_cshtml : System.Web.Mvc.WebViewPage<DataModel.Models.BussSubFeeFact>
    {
        public _Views_BussSubFeeFact_info_cshtml()
        {
        }
...
WriteLiteral(">\r\n    alert(1);\r\n    var x = 0;\r\n    var requestconsuburl = \'");
            ...
            #line 7 "..\..\Views\BussSubFeeFact\info.cshtml"
...
WriteLiteral("?CompanyType=FGS\';\r\n    var requestprojsuburl = \'");
            ...
            #line 8 "..\..\Views\BussSubFeeFact\info.cshtml"
...
WriteLiteral(@"?CompanyType=FGS';
    ...
    $(function () {
        ...
        $(""#SubFeeFactGrid"").datagrid({
            ...
            #line 42 "..\..\Views\BussSubFeeFact\info.cshtml"
...
"i < data.length; i++) {\r\n            var node = parentNode.ownerDocument.createE" +
"lement(\"Item\");\r\n            node.setAttribute(\"Id\", data[i].Id);\r\n            n" +
"ode.setAttribute(\"ConSubId\", $(\"#c_ConSubId\" + data[i].Id).combogrid(\'grid\').dat" +
"agrid(\'getSelected\').Id);\r\n            node.setAttribute(\"ProjSubId\", $(\"#c_Proj" +
"SubId\" + data[i].Id).combogrid(\'grid\').datagrid(\'getSelected\') == null ? 0 : $(\"" +
"#c_ProjSubId\" + data[i].Id).combogrid(\'grid\').datagrid(\'getSelected\').Id);\r\n    " +
"        node.setAttribute(\"ConSubFee\", $(\"#c_ConSubFee\" + data[i].Id).val());\r\n " +
"           node.setAttribute(\"AlreadySumFeeMoney\", $(\"#c_AlreadySumFeeMoney\" + d" +
"ata[i].Id).val());\r\n            node.setAttribute(\"SubFeeFactMoney\", $(\"#c_SubFe" +
"eFactMoney\" + data[i].Id).val());\r\n            node.setAttribute(\"SubFeeFactDate" +
"\", $(\"#c_SubFeeFactDate\" + data[i].Id).datebox(\'getValue\'));\r\n            node.s" +
"etAttribute(\"TotalRatio\", $(\"#c_TotalRatio\" + data[i].Id).val());\r\n            n" +
"ode.setAttribute(\"IsSettle\", $(\"#c_IsSettle\" + data[i].Id).val());\r\n            " +
"parentNode.appendChild(node);\r\n            if (data[i].children && data[i].child" +
"ren.length > 0) {\r\n                recuriseData(data[i].children, node);\r\n      " +
"      }\r\n        }\r\n    }\r\n</script>\r\n");

            
            #line 225 "..\..\Views\BussSubFeeFact\info.cshtml"
 using (Html.BeginForm("save", "BussSubFeeFact", FormMethod.Post, new { @area = "Bussiness", @id = "BussSubFeeFactForm" }))
{
            ...
            #line 227 "..\..\Views\BussSubFeeFact\info.cshtml"
...
WriteLiteral(">\r\n");
            ...
            #line 249 "..\..\Views\BussSubFeeFact\info.cshtml"
            ...
            #line 254 "..\..\Views\BussSubFeeFact\info.cshtml"
...
WriteLiteral(" />\r\n    </div>\r\n");
            ...
            #line 265 "..\..\Views\BussSubFeeFact\info.cshtml"
...
WriteLiteral(" />\r\n");
            ...
            #line 267 "..\..\Views\BussSubFeeFact\info.cshtml"
                    }
