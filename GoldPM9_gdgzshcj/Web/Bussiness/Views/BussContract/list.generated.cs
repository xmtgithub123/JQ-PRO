...
namespace ASP
{
    ...
    #line 4 "..\..\Views\BussContract\list.cshtml"
    using JQ.Web;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/BussContract/list.cshtml")]
    public partial class _Views_BussContract_list_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_BussContract_list_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral(">\r\n\r\n        var queryParams={\r\n                CustID: \"");
            ...
            #line 10 "..\..\Views\BussContract\list.cshtml"
...
"       if ((");
            ...
            #line 14 "..\..\Views\BussContract\list.cshtml"
...
"\r\n\r\n");
            ...
            #line 18 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral("queryParams.ProjID=\"");
            ...
            #line 21 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral("\r\n");
            ...
            #line 22 "..\..\Views\BussContract\list.cshtml"
                }
...
WriteLiteral("\r\n");
            ...
            #line 27 "..\..\Views\BussContract\list.cshtml"
                }
                else
                {
...
WriteLiteral("\r\n");
            ...
            #line 31 "..\..\Views\BussContract\list.cshtml"
                }
...
"        JQButtonTypes: buttons,//需要显示的按钮\r\n                JQAddUrl: \'");
            ...
            #line 36 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral("?CompanyType=FGS\',//添加的路径\r\n                JQEditUrl: \'");
            ...
            #line 37 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral("?CompanyType=FGS\',//编辑的路径\r\n                JQDelUrl: \'");
            ...
            #line 38 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral(@"',//删除的路径
            ...
            #line 50 "..\..\Views\BussContract\list.cshtml"
...
"sContractPanel\',//工具栏的容器ID\r\n                showFooter: true,\r\n                n" +
"owrap: false,\r\n                frozenColumns: [[\r\n                    { field: \'" +
"ck\', align: \'center\', checkbox: true, JQIsExclude: true },\r\n                    " +
"{ title: \'合同编号\', field: \'ConNumber\', width: \"180px\", halign: \'center\', align: \'l" +
"eft\', sortable: true },\r\n                    {\r\n                        title: \'" +
"合同名称\', field: \'ConName\', width: \"20%\", halign: \'center\', align: \'left\', sortable" +
": true, formatter: function (item, data) {\r\n                            return \"" +
"<span title=\'\" + item + \"\'>\" + item + \"</span>\";\r\n                        }\r\n   " +
"                 },\r\n                ]],\r\n                columns: [[\r\n         " +
"           { title: \'客户名称\', field: \'CustName\', width: \"10%\", halign: \'center\', a" +
"lign: \'left\', sortable: true },\r\n                    {\r\n                        " +
"title: \'签订状态\', field: \'ConStatus\', width: \"80px\", halign: \'center\', align: \'cent" +
"er\', sortable: true, formatter: function (item, row) {\r\n                        " +
"    if (row.Footer) {\r\n                                return \"\";\r\n             " +
"               }\r\n                            row.ConStatus =row.ConStatusShow;\r" +
"\n                            return row.ConStatusShow;\r\n                        " +
"}\r\n                    },\r\n                    { title: \'签订日期\', field: \'ConDate\'" +
", width: \"80px\", halign: \'center\', align: \'center\', sortable: true, formatter: J" +
"Q.tools.DateTimeFormatterByT },\r\n                    {\r\n                        " +
"title: \'合同金额\', field: \'NewConFee\', width: \"100px\", halign: \'center\', align: \'rig" +
"ht\', formatter: function (value, row, index) {\r\n                            if (" +
"row.Footer) {\r\n                                return row.NewConFee;\r\n          " +
"                  }\r\n                            if (row.FatherID == 0) {\r\n     " +
"                           if (row.ConFulfilType == \'");

            
            #line 83 "..\..\Views\BussContract\list.cshtml"
...
"else {\r\n                                if (row.ConFulfilType == \'");
            ...
            #line 116 "..\..\Views\BussContract\list.cshtml"
                                                      Write((int)DataModel.ConDealWays.开口);
...
"pe == \'");
            ...
            #line 147 "..\..\Views\BussContract\list.cshtml"
                                                      Write((int)DataModel.ConDealWays.开口);
...
"StatusName\", \"FlowTurnedEmpIDs\", \"CreatorEmpId\", \"");
            ...
            #line 230 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral(@""")(value, row);
            ...
            #line 252 "..\..\Views\BussContract\list.cshtml"
...
"票\",\r\n                url: \'");
            ...
            #line 353 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral(@"' + '?ConID=' + ConID,
        ...
        function OpenConSub(projId,EngineeringNumber){
            ...
            #line 368 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral(@"?projectID='+projId+'&EngineeringNumber='+EngineeringNumber+'',
        ...
        function AddCon() {
            ...
            #line 395 "..\..\Views\BussContract\list.cshtml"
                     Write(Url.Action("AddChild"));

            
            #line default
            #line hidden
WriteLiteral(@"' + '?CompanyType=FGS&parentId=' + row[0]['Keyid'],
                    width: '1024',
                    height: '100%',
                    JQID: 'BussContractGrid',
                    JQLoadingType: 'treegrid',
        ...
        function EditCon(id) {
            ...
            #line 409 "..\..\Views\BussContract\list.cshtml"
                     Write(Url.Action("edit"));
...
WriteLiteral("    ");
            ...
            #line 427 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral(">\r\n");
            ...
            #line 433 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral("></span>\r\n");
            ...
            #line 437 "..\..\Views\BussContract\list.cshtml"
            }
...
WriteLiteral(">\r\n            <span>\r\n                履行方式：");
            ...
            #line 444 "..\..\Views\BussContract\list.cshtml"
...
WriteLiteral("\r\n            </span>\r\n\r\n            <span>\r\n                签订状态：");
            ...
            #line 456 "..\..\Views\BussContract\list.cshtml"
                Write(BaseData.getBases(new Params()
                {
                    isMult = true,
