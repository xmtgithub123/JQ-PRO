...
namespace ASP
{
    ...
    #line 2 "..\..\Views\BussFeeFact\info_sj.cshtml"
    using JQ.Web;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/BussFeeFact/info_sj.cshtml")]
    public partial class _Views_BussFeeFact_info_sj_cshtml : System.Web.Mvc.WebViewPage<DataModel.Models.BussFeeFact>
    {
        public _Views_BussFeeFact_info_sj_cshtml()
        {
        }
...
");
            ...
            #line 37 "..\..\Views\BussFeeFact\info_sj.cshtml"
 using (Html.BeginForm("save", "BussFeeFact", FormMethod.Post, new { @area = "Bussiness", @id = "BussFeeFactForm" }))
{
            ...
            #line 39 "..\..\Views\BussFeeFact\info_sj.cshtml"
...
WriteLiteral(@">
            ...
            #line 61 "..\..\Views\BussFeeFact\info_sj.cshtml"
...
WriteLiteral("?CompanyType=SJ\',//请求的地址\r\n                            queryParams: {ConID:");
            ...
            #line 62 "..\..\Views\BussFeeFact\info_sj.cshtml"
                                           Write(Model.Id);
...
WriteLiteral(@"},
            ...
            #line 76 "..\..\Views\BussFeeFact\info_sj.cshtml"
                                             Write(Url.Action("json","BussContract"));

            
            #line default
            #line hidden
WriteLiteral(@"?CompanyType=SJ&FatherID=0',
            ...
            #line 90 "..\..\Views\BussFeeFact\info_sj.cshtml"
...
" (rowData.ConFulfilType == \'");
            ...
            #line 111 "..\..\Views\BussFeeFact\info_sj.cshtml"
                                                                          Write((int)DataModel.ConDealWays.开口);
...
"ield: \'ProjName\',\r\n                                            url: \'");
            ...
            #line 141 "..\..\Views\BussFeeFact\info_sj.cshtml"
...
"(\'load\',{Filter:keyword,FatherID:\'0\'});\r\n                                       " +
"         $(this).combogrid(\"setValue\", keyword);\r\n                              " +
"              }},\r\n                                        }\r\n                  " +
"                  }\r\n                                },\r\n                       " +
"         { title: \'合同金额\', field: \'ConFee\', width: 100, align: \'right\',editor:\'sp" +
"an\'},\r\n                                { title: \'已收款金额\', field: \'SumFeeMoney\', w" +
"idth: 100, align: \'right\',editor:\'span\'},\r\n                                { tit" +
"le: \'本次收款金额\', field: \'FeeMoney\', width: 100, align: \'right\',editor:{type:\'number" +
"box\',options: {  precision: 2,  required: true,onChange:function (_new,_old) {\r\n" +
"                                    if ($(this).attr(\"_row\")!=undefined) {\r\n    " +
"                                    GetPercent($(this).attr(\"_row\"));\r\n         " +
"                           }\r\n                                } }}},\r\n          " +
"                      { title: \'本次收款日期\', field: \'FeeData\', width: 100, align: \'c" +
"enter\',  editor: { type: \'datebox\',   options: { validType: [\'dateISO\'],required" +
": true } }  },\r\n                                { title: \'累计比例\', field: \'Persent" +
"\', width: 80, align: \'center\', JQIsExclude: true,editor:\'span\' },\r\n             " +
"                   { title: \'是否结清\', field: \'IsSettle\', width: 100, align: \'cente" +
"r\', JQIsExclude: true },\r\n                            ]],\r\n                     " +
...
"\r\n                        });\r\n                    });\r\n\r\n                    fu" +
"nction Add() {\r\n                        var rowlength=typeof($(\'#FeeGrid\').datag" +
"rid(\"getRows\"))==\"undefined\"?0:$(\'#FeeGrid\').datagrid(\"getRows\").length;\r\n      " +
"                  $(\'#FeeGrid\').datagrid(\'appendRow\', {});\r\n                    " +
"    $(\'#FeeGrid\').datagrid(\'beginEdit\', rowlength);\r\n\r\n                        v" +
"ar ed = $(\'#FeeGrid\').datagrid(\'getEditors\', rowlength)[0];\r\n                   " +
...
"$(EditorArray[2].target).attr(\"CurrentConFee\")))?0:parseFloat($(EditorArray[2].t" +
"arget).attr(\"CurrentConFee\"));\r\n                        //获取已收款\r\n               " +
"         var HasFee=isNaN(parseFloat($(EditorArray[3].target).text()))?0:parseFl" +
"oat($(EditorArray[3].target).text());\r\n                        //获取本次收款金额\r\n     " +
"                   var getNum= isNaN(parseFloat($(EditorArray[4].target).numberb" +
"ox(\'getValue\')))?0:parseFloat($(EditorArray[4].target).numberbox(\'getValue\'));\r\n" +
"                        if (CurrentConFee==0) {\r\n                            $(E" +
"ditorArray[6].target).text(\"0%\");\r\n                        }\r\n                  " +
"      else {\r\n                            $(EditorArray[6].target).text(((HasFee" +
"+getNum)/CurrentConFee*100).toFixed(2)+\"%\");\r\n                            if ((C" +
"urrentConFee-HasFee)>0) {\r\n                                $(EditorArray[4].targ" +
"et).numberbox({prompt:(CurrentConFee-HasFee)});\r\n                            }\r\n" +
"                        }\r\n\r\n                        $(EditorArray[6].target).at" +
"tr(\"title\",\"(已收款金额+本次收款金额)/合同金额\");\r\n                    }\r\n                </scr" +
"ipt>\r\n            </td>\r\n        </tr>\r\n\r\n        <tr>\r\n            <th");
...
WriteAttribute("value", Tuple.Create(" value=\"", 14281), Tuple.Create("\"", 14303)
            
            #line 218 "..\..\Views\BussFeeFact\info_sj.cshtml"
                                                             , Tuple.Create(Tuple.Create("", 14289), Tuple.Create<System.Object, System.Int32>(Model.FeeNote
...
WriteAttribute("value", Tuple.Create(" value=\"", 14504), Tuple.Create("\"", 14524)
            
            #line 222 "..\..\Views\BussFeeFact\info_sj.cshtml"
                                   , Tuple.Create(Tuple.Create("", 14512), Tuple.Create<System.Object, System.Int32>(Model.EmpId
...
WriteLiteral("                ");
            ...
            #line 231 "..\..\Views\BussFeeFact\info_sj.cshtml"
...
WriteLiteral("\r\n            </td>\r\n        </tr>\r\n    </table>\r\n");
            ...
            #line 240 "..\..\Views\BussFeeFact\info_sj.cshtml"
}
