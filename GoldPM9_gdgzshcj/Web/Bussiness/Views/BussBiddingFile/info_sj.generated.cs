...
namespace ASP
{
    ...
    #line 2 "..\..\Views\BussBiddingFile\info_sj.cshtml"
    using JQ.Web;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/BussBiddingFile/info_sj.cshtml")]
    public partial class _Views_BussBiddingFile_info_sj_cshtml : System.Web.Mvc.WebViewPage<DataModel.Models.Project>
    {
        public _Views_BussBiddingFile_info_sj_cshtml()
        {
        }
...
WriteAttribute("src", Tuple.Create(" src=\"", 56), Tuple.Create("\"", 116)
            ...
            #line 3 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral(@">
    $(function () {
        JQ.form.submitInit({
            ...
            #line 27 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
"闭窗体放在最后一步执行，以避免找不到事件源\r\n            },flow:{\r\n                flowNodeID: \"");
            ...
            #line 33 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral("\",\r\n                flowMultiSignID: \"");
            ...
            #line 34 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral("\",\r\n                url: \"");
            ...
            #line 35 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
"      refID: \"");
            ...
            #line 41 "..\..\Views\BussBiddingFile\info_sj.cshtml"
                    Write(Model.Id);

            
            #line default
            #line hidden
WriteLiteral("\",\r\n                refTable: \"BussBiddingFile_SJ\",\r\n                dataCreator:" +
"\"");

            
            #line 43 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral(@""",
        ...
        if(");
            ...
            #line 70 "..\..\Views\BussBiddingFile\info_sj.cshtml"
      Write(Model.Id);
...
WriteLiteral(">0)\r\n        {\r\n            $(\"#BiddingBatch\").val(\'");
            ...
            #line 72 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral("\');\r\n            $(\"#BiddingNumber\").val(\'");
            ...
            #line 73 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral("\');\r\n            $(\"#PackageNumber\").val(\'");
            ...
            #line 74 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral("\');\r\n            $(\"#EngineeringName\").val(\'");
            ...
            #line 75 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral("\');\r\n            $(\"#BiddingId\").val(");
            ...
            #line 76 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral(");\r\n            $(\"#BiddingInfoID\").val(");
            ...
            #line 77 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral(");\r\n            $(\"#Duration\").val(");
            ...
            #line 78 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
"ialog.dialog({\r\n            title: \"选择投标信息\",\r\n            url: \'");
            ...
            #line 85 "..\..\Views\BussBiddingFile\info_sj.cshtml"
             Write(Url.Action("ListInfo", "BussBiddingInfo", new { @area = "Bussiness" }));

            
            #line default
            #line hidden
WriteLiteral(@"?CompanyType=SJ&IsFilter=0',
            width: '1024',
            height: '100%',
    ...
    if(");
            ...
            #line 107 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral("!=0)\r\n    {\r\n        debugger;\r\n        $(\"#ProjEmpId\").combotree(\'setValue\',");
            ...
            #line 110 "..\..\Views\BussBiddingFile\info_sj.cshtml"
                                        Write(ViewData["ProjEmpId1"]);
...
WriteLiteral(");\r\n    }\r\n    if(");
            ...
            #line 112 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral("!=0)\r\n    {\r\n        $(\"#BusinessEmpId\").combotree(\'setValue\',");
            ...
            #line 114 "..\..\Views\BussBiddingFile\info_sj.cshtml"
                                            Write(ViewData["BusinessEmpId1"]);
...
WriteLiteral(");\r\n    }\r\n    if(");
            ...
            #line 116 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral("!=0)\r\n    {\r\n        $(\"#TechnologyEmpId\").combotree(\'setValue\',");
            ...
            #line 118 "..\..\Views\BussBiddingFile\info_sj.cshtml"
                                              Write(ViewData["TechnologyEmpId1"]);
...
"\r\n    }\r\n</script>\r\n");
            ...
            #line 173 "..\..\Views\BussBiddingFile\info_sj.cshtml"
 using (Html.BeginForm("save", "BussBiddingFile", FormMethod.Post, new { @area = "Bussiness", @id = "BussBiddingFileForm" }))
{
            ...
            #line 175 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 8107), Tuple.Create("\"", 8130)
            
            #line 192 "..\..\Views\BussBiddingFile\info_sj.cshtml"
                                                   , Tuple.Create(Tuple.Create("", 8115), Tuple.Create<System.Object, System.Int32>(Model.ProjName
...
WriteAttribute("JQvalue", Tuple.Create(" JQvalue=\"", 8309), Tuple.Create("\"", 8335)
            
            #line 198 "..\..\Views\BussBiddingFile\info_sj.cshtml"
, Tuple.Create(Tuple.Create("", 8319), Tuple.Create<System.Object, System.Int32>(Model.ProjEmpId
...
WriteAttribute("JQvalue", Tuple.Create(" JQvalue=\"", 8559), Tuple.Create("\"", 8587)
            
            #line 202 "..\..\Views\BussBiddingFile\info_sj.cshtml"
, Tuple.Create(Tuple.Create("", 8569), Tuple.Create<System.Object, System.Int32>(Model.ColAttType9
...
WriteAttribute("value", Tuple.Create(" value=\"", 8912), Tuple.Create("\"", 8940)
            
            #line 208 "..\..\Views\BussBiddingFile\info_sj.cshtml"
                                                              , Tuple.Create(Tuple.Create("", 8920), Tuple.Create<System.Object, System.Int32>(Model.DatePlanStart
...
WriteAttribute("value", Tuple.Create(" value=\"", 9172), Tuple.Create("\"", 9201)
            
            #line 212 "..\..\Views\BussBiddingFile\info_sj.cshtml"
                                                                , Tuple.Create(Tuple.Create("", 9180), Tuple.Create<System.Object, System.Int32>(Model.DatePlanFinish
...
WriteLiteral("                ");
            ...
            #line 218 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral(">\r\n");
            ...
            #line 226 "..\..\Views\BussBiddingFile\info_sj.cshtml"
            ...
            #line 231 "..\..\Views\BussBiddingFile\info_sj.cshtml"
...
WriteLiteral(" />\r\n");
            ...
            #line 239 "..\..\Views\BussBiddingFile\info_sj.cshtml"
                    }
