...
namespace ASP
{
    ...
    #line 6 "..\..\Views\BussContractOther\list.cshtml"
    using JQ.Web;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/BussContractOther/list.cshtml")]
    public partial class _Views_BussContractOther_list_cshtml : System.Web.Mvc.WebViewPage<DataModel.Models.BaseEmployee>
    {
        public _Views_BussContractOther_list_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Views\BussContractOther\list.cshtml"
...
"        JQAddUrl: \'");
            ...
            #line 12 "..\..\Views\BussContractOther\list.cshtml"
...
WriteLiteral("?CompanyType=FGS\',//添加的路径\r\n                JQEditUrl: \'");
            ...
            #line 13 "..\..\Views\BussContractOther\list.cshtml"
...
WriteLiteral("?CompanyType=FGS\',//编辑的路径\r\n                JQDelUrl: \'");
            ...
            #line 14 "..\..\Views\BussContractOther\list.cshtml"
...
WriteLiteral(@"',//删除的路径
            ...
            #line 28 "..\..\Views\BussContractOther\list.cshtml"
...
WriteLiteral(@"?CompanyType=FGS&Footer=true',//请求的地址
                ...
                { title: '客户单位', field: 'CustName', width: ""14%"", align: 'left', sortable: true },
        {
            ...
            #line 42 "..\..\Views\BussContractOther\list.cshtml"
...
WriteLiteral(@"') {
        ...
        { title: '已收款（元）', field: 'SumFeeMoney', width: ""8%"", align: 'right', sortable: false },
        {
            ...
            #line 59 "..\..\Views\BussContractOther\list.cshtml"
                                           Write((int)DataModel.ConDealWays.开口);
...
"\n                } else {\r\n                    var value = row.NoConrBalanceFeeM" +
"oney;\r\n                    if (value <= 0) {\r\n                        value = 0;" +
"\r\n                    }\r\n                    row.NoFeeMoney = value;//更新数据行数据\r\n " +
"                   return value;\r\n                }\r\n            }\r\n        },\r\n" +
"        { title: \'已开票（元）\', field: \'SumInvoiceMoney\', width: \"8%\", align: \'right\'" +
", sortable: false },\r\n        { field: \'JQFiles\', title: \'附件\', align: \'center\', " +
"width: \"6%\", JQIsExclude: true, JQRefTable: \'BussContractOther\' },\r\n        {\r\n " +
"           title: \'是否结清\', field: \'ConIsFeeFinished\', width: \"8%\", align: \'center" +
"\', formatter: function (val, row) {\r\n                if (row.Footer) {\r\n        " +
"            return \"\";\r\n                }\r\n                else {\r\n             " +
"       return val == \"已结清\" ? \"<span style=\'color:green\'>已结清</span>\" : \"<span sty" +
"le=\'color:red\'>未结清</span>\";\r\n                }\r\n            }\r\n        },\r\n     " +
"   {\r\n            field: \'opt\', title: \'操作\', width: \"12%\", align: \'center\',\r\n   " +
"         formatter: function (value, row, index) {\r\n                if (row.Foot" +
"er) {\r\n                    return \"\";\r\n                }\r\n                return" +
" \"<a href=\\\"javascript:void(0)\\\"   JQPermissionName=\\\"add\\\" id=\\\"mb\" + index + \"" +
"\\\" dataid=\\\"\" + row.Id + \"\\\" flag=\\\"menubutton\\\"   >操作</a>\";\r\n            }\r\n   " +
"     }\r\n                ]],\r\n                onLoadSuccess: function (row, data)" +
" {\r\n                    var htmlFooter = $(\"#BussContractOtherGrid\").datagrid(\"g" +
"etPanel\").find(\".datagrid-footer\").find(\"tr\");\r\n                    htmlFooter.f" +
"ind(\"td[field=\\\"JQFiles\\\"]\").find(\".datagrid-cell\").empty();\r\n                  " +
"  htmlFooter.find(\"td[field=\\\"FlowProgress\\\"]\").find(\".datagrid-cell\").empty();\r" +
"\n\r\n                }\r\n            });\r\n            $(\"#JQSearch\").textbox({\r\n   " +
...
"                        queryParams: {\r\n                                KeyJQSea" +
"rch: $(\"#JQSearch\").val(),\r\n                            }\r\n                     " +
"   });\r\n                }\r\n            });\r\n            //setTextAlign(\"ConNumbe" +
"r\", \"text-align:left;\");\r\n            //setTextAlign(\"ConrName\", \"text-align:lef" +
"t;\");\r\n        });\r\n\r\n        //function setTextAlign(filed, align) {\r\n        /" +
"/    $(\"tr[class=\'datagrid-header-row\']\").find(\"td[field=\'\" + filed + \"\']\").chil" +
"dren().removeAttr(\"style\").attr(\"style\", align);\r\n        //}\r\n\r\n        $.exten" +
"d($.fn.datagrid.defaults.view, {\r\n            onAfterRender: function () {\r\n    " +
"            $(\"a[flag=\'menubutton\']\").mouseover(function () {\r\n                 " +
"   document.getElementById(\"mm3\").setAttribute(\"rowid\", this.getAttribute(\"datai" +
"d\"));\r\n                }).menubutton({\r\n                    iconCls: \'fa fa-edit" +
"\',\r\n                    menu: \'#mm3\'\r\n                });\r\n            }\r\n      " +
...
",\r\n                        url: \'");
            ...
            #line 147 "..\..\Views\BussContractOther\list.cshtml"
...
WriteLiteral(@"' + '?CompanyType=FGS&Id=' + key,
            ...
            #line 161 "..\..\Views\BussContractOther\list.cshtml"
                         Write(Url.Action("edit"));
...
WriteLiteral("    ");
            ...
            #line 174 "..\..\Views\BussContractOther\list.cshtml"
...
WriteLiteral("        ");
            ...
            #line 193 "..\..\Views\BussContractOther\list.cshtml"
