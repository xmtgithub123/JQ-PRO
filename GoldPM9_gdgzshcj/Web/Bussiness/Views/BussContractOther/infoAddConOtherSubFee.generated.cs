...
namespace ASP
{
    ...
    #line 2 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
    using JQ.Web;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/BussContractOther/infoAddConOtherSubFee.cshtml")]
    public partial class _Views_BussContractOther_infoAddConOtherSubFee_cshtml : System.Web.Mvc.WebViewPage<DataModel.Models.BussContractOther>
    {
        public _Views_BussContractOther_infoAddConOtherSubFee_cshtml()
        {
        }
...
WriteLiteral(@">
        ...
        JQ.form.submitInit({
            ...
            succesCollBack: function (data) {//成功回调函数,data为服务器返回值
                JQ.datagrid.autoRefDataGird();//刷新上一级数据表格，必须在close窗体前调用
    ...
    var ConIsFeeFinished= '");
            ...
            #line 40 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
"\n    var editUrl = \'");
            ...
            #line 48 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
WriteLiteral(@"';
    ...
    function editIsFeeFinished(isValue) {
        ...
        $.ajax({
            ...
            #line 67 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
WriteLiteral("\",\r\n            data: { isValue: isValue ,Id:");
            ...
            #line 68 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
                                    Write(Model.Id);
...
");
            ...
            #line 95 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
 using (Html.BeginForm("saveIsFeeFinished", "BussContractOther", FormMethod.Post, new { @area = "Bussiness", @id = "BussContractOtherFeeForm" }))
{
            ...
            #line 97 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
WriteLiteral("                    ");
            ...
            #line 105 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
WriteLiteral("                    ");
            ...
            #line 109 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
WriteLiteral("                    ");
            ...
            #line 113 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
               Write(Model.ConFee);
...
WriteLiteral("\r\n                </td>\r\n            </tr>\r\n        </table>\r\n\r\n    </div>\r\n");
            ...
            #line 119 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
WriteLiteral(@">
            ...
            #line 141 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
WriteLiteral("\',//请求的地址\r\n                    queryParams: {ConOtherID:");
            ...
            #line 142 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
                                        Write(Model.Id);
...
"e },\r\n\r\n                        { title: \'付款日期\', field: \'FeerDate\', width:  \"15%" +
"\", align: \'center\',formatter: JQ.tools.DateTimeFormatterByT,\r\n                  " +
"          editor: {\r\n                                type: \'datebox\',\r\n         " +
"                       options: { validType: { date: \'yyyy-MM-dd\' },required: tr" +
"ue } }\r\n                        },\r\n                        { title: \'金额(元)\', fi" +
"eld: \'FeeMoney\', width:  \"15%\", align: \'right\',editor:{type:\'numberspinner\',opti" +
"ons: {  precision: 2, prefix: \'￥\', required: true }}},\r\n                        " +
"{ title: \'付款说明\', field: \'FeeNote\', width:  \"25%\", align: \'center\', sortable: fal" +
"se, editor: { type: \'textbox\', options: { validType: length[0, 23] } }  },\r\n\r\n  " +
"                  { title: \'经办人\', field: \'CreatorEmpName\', width:  \"15%\", align:" +
" \'center\', sortable: false,JQIsExclude: true },\r\n                          { tit" +
"le: \'操作\', field: \'Id\', width:  \"15%\", align: \'center\', sortable: false,JQIsExclu" +
"de: true,formatter: function (value, row, index) {\r\n                            " +
"  if (IsEdit) {\r\n                                  if (editIndex==-1) {\r\n       " +
"                               //新增一行\r\n                                      ret" +
"urn \"<a href=\\\"#\\\" class=\\\"easyui-linkbutton\\\"  style=\\\"line-height:22px;\\\" oncl" +
"ick=\\\"endEditing(this)\\\">创建</>\";\r\n                                  }else {\r\n   " +
"                                   return \"<a href=\\\"#\\\" class=\\\"easyui-linkbutt" +
"on\\\"  style=\\\"line-height:22px;\\\" onclick=\\\"endEditing(this)\\\">更新</>&nbsp;&nbsp;" +
"&nbsp;<a href=\\\"#\\\" class=\\\"easyui-linkbutton\\\"  style=\\\"line-height:22px;paddin" +
"g-margin:10px\\\" onclick=\\\"CannelRow()\\\">取消</>\";\r\n                               " +
"   }\r\n\r\n                              }\r\n                              else  {\r\n" +
"                                  return \"<a href=\\\"#\\\" class=\\\"easyui-linkbutto" +
"n\\\"  style=\\\"line-height:22px;\\\" onclick=\\\"onDblClickRow(\"+index+\")\\\">编辑</>\";\r\n " +
"                             }\r\n                          }\r\n                   " +
"       },\r\n                    ]],\r\n                    onDblClickRow: onDblClic" +
"kRow,\r\n                });\r\n            })\r\n\r\n            var IsEdit=false;//是否在" +
"编辑状态(true编辑、false列表)\r\n            var editIndex=-1;//编辑行号\r\n            //新增行\r\n  " +
"          function FeeFactAdd() {\r\n                if (IsEdit==false) {\r\n       " +
"             IsEdit=true;\r\n                    //var _rowC=$(\'#planTable\').datag" +
"rid(\'getRows\').length==undefined?0:$(\'#planTable\').datagrid(\'getRows\').length;\r\n" +
"                    editIndex=-1;\r\n                    $(\'#FeeFactGrid\').datagri" +
"d(\'appendRow\', {});\r\n                    editIndex = $(\'#FeeFactGrid\').datagrid(" +
"\'getRows\').length - 1;\r\n                    $(\'#FeeFactGrid\').datagrid(\'beginEdi" +
"t\', editIndex);\r\n                }\r\n            }\r\n            //编辑\r\n           " +
...
"             } else {\r\n                    alert(\"第\"+(parseInt(editIndex)+1)+\"行正" +
"在编辑\");\r\n                    //取消编辑行\r\n                    //$(\'#planTable\').datag" +
"rid(\'selectRow\', editIndex);\r\n                }\r\n            }\r\n            //创建" +
"、更新\r\n            function endEditing(objEvent) {\r\n                if (IsEdit) {\r" +
"\n                    //编辑状态、验证下\r\n                    if ($(\'#FeeFactGrid\').datag" +
...
"          //combox赋值\r\n                        //$(\'#FeeFactGrid\').datagrid(\'getR" +
"ows\')[editIndex][\'text\'] = productname;\r\n                        //$(\'#FeeFactGr" +
"id\').datagrid(\'getRows\')[editIndex][\'ProjId\'] = _id;\r\n                        //" +
"checkbox赋值\r\n                        //var CheckB = $(ed[4].target);\r\n           " +
"             IsEdit=false;\r\n                        //$(\'#FeeFactGrid\').datagrid" +
"(\'getRows\')[editIndex][\'FinishedCheck\']=($(CheckB).is(\":checked\")?\"1\":\"0\");\r\n   " +
"                     $(\'#FeeFactGrid\').datagrid(\'endEdit\', editIndex);\r\n\r\n      " +
"                  var _postDate=$(\'#FeeFactGrid\').datagrid(\'getRows\')[editIndex]" +
";\r\n                        _postDate.RefID=");

            
            #line 226 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
                                   Write(Model.Id);
...
WriteLiteral(";\r\n                        $.post(\'");
            ...
            #line 227 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
                           Write(Url.Action("save", "BussContractOtherFeeFact"));

            
            #line default
            #line hidden
WriteLiteral("?Id=\'+(_postDate.hasOwnProperty(\"Id\")?_postDate.Id:0)+\'&FactTypeID=1\',_postDate,f" +
"unction () {\r\n                            JQ.dialog.show(\"操作成功！\");\r\n            " +
"                $(\'#FeeFactGrid\').datagrid(\'reload\');\r\n                         " +
"   //$(\'#FeeFactGrid\').datagrid(\'refreshRow\', editIndex);//刷新行\r\n                " +
"            //editIndex=-1;\r\n\r\n                            //FeeFactAdd();\r\n    " +
"                    }).error(function (a) {\r\n                            var Cur" +
"rentIndex=editIndex;\r\n                            editIndex=_postDate.hasOwnProp" +
"erty(\"Id\")?editIndex:-1;\r\n                            IsEdit=true;\r\n            " +
...
"           editIndex=-1;\r\n            }\r\n            //删除行\r\n            function" +
" FeeFactDel() {\r\n                var row = $(\'#FeeFactGrid\').datagrid(\'getSelect" +
"ions\');\r\n                if (row.length==0) {\r\n                    JQ.dialog.war" +
"ning(\"请至少选择一项！！！\");\r\n                    return;\r\n                }\r\n           " +
"     if (!confirm(\"你确定要删除吗?\")) {\r\n                    return;\r\n                }" +
"\r\n\r\n                var DelIds=[];\r\n                var KeyID=\"\";\r\n             " +
...
"dex=$(\'#FeeFactGrid\').datagrid(\'getRowIndex\',row[i]);\r\n\r\n                    if " +
...
"h(_rowindex);\r\n                }\r\n\r\n                $.post(\'");
            ...
            #line 285 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
");
            ...
            #line 302 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
"\r\n                    pagination: false,\r\n                    url: \'");
            ...
            #line 320 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
WriteLiteral("\',//请求的地址\r\n                    queryParams: { ConOtherID:");
            ...
            #line 321 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
                                         Write(Model.Id);
...
"");
            ...
            #line 410 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
                                   Write(Model.Id);
...
WriteLiteral(";\r\n                        $.post(\'");
            ...
            #line 411 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
                           Write(Url.Action("save", "BussContractOtherInvoice"));

            
            #line default
            #line hidden
WriteLiteral("?Id=\'+(_postDate.hasOwnProperty(\"Id\")?_postDate.Id:0)+\'&ConOtherTypeID=1\',_postDa" +
"te,function () {\r\n                            JQ.dialog.show(\"操作成功！\");\r\n        " +
...
"ditIndex=_postDate.hasOwnProperty(\"Id\")?InvoiceeditIndex:-1;\r\n                  " +
"          InvoiceIsEdit=true;\r\n                            $(\'#InvoiceGrid\').dat" +
"agrid(\'refreshRow\', CurrentIndex);//刷新行\r\n                            $(\'#Invoice" +
"Grid\').datagrid(\'beginEdit\', CurrentIndex);\r\n                            Invoice" +
"editIndex=CurrentIndex;\r\n                            alert(a.responseText);\r\n   " +
"                     });\r\n                        JQ.datagrid.autoRefdatagrid();" +
"\r\n                    } else {\r\n                        return false;\r\n         " +
"           }\r\n                }\r\n\r\n            }\r\n            //行取消\r\n           " +
...
"    InvoiceeditIndex=-1;\r\n            }\r\n            //删除行\r\n            function" +
" InvoiceDel() {\r\n                var row = $(\'#InvoiceGrid\').datagrid(\'getSelect" +
"ions\');\r\n                if (row.length == 0) {\r\n                    JQ.dialog.w" +
"arning(\"请至少选择一项！！！\");\r\n                    return;\r\n                }\r\n         " +
"       if (!confirm(\"你确定要删除吗?\")) {\r\n                    return;\r\n               " +
" }\r\n                var DelIds = [];\r\n                var KeyID = \"\";\r\n         " +
"       var _CurrentEditRow = $(\"#InvoiceGrid\").datagrid(\"getRows\")[InvoiceeditIn" +
"dex];\r\n                for (var i = 0; i < row.length; i++) {\r\n                 " +
...
"\n\r\n                $.post(\'");
            ...
            #line 469 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
...
");
            ...
            #line 488 "..\..\Views\BussContractOther\infoAddConOtherSubFee.cshtml"
}
