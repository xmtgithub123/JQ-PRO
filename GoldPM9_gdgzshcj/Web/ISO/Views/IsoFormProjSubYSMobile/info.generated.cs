...
namespace ASP
{
    ...
    #line 5 "..\..\Views\IsoFormProjSubYSMobile\info.cshtml"
    using JQ.Web;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/IsoFormProjSubYSMobile/info.cshtml")]
    public partial class _Views_IsoFormProjSubYSMobile_info_cshtml : System.Web.Mvc.WebViewPage<DataModel.Models.IsoForm>
    {
        public _Views_IsoFormProjSubYSMobile_info_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Views\IsoFormProjSubYSMobile\info.cshtml"
...
WriteLiteral("                    ");
            ...
            #line 121 "..\..\Views\IsoFormProjSubYSMobile\info.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 3047), Tuple.Create("\"", 3068)
            
            #line 124 "..\..\Views\IsoFormProjSubYSMobile\info.cshtml"
, Tuple.Create(Tuple.Create("", 3055), Tuple.Create<System.Object, System.Int32>(Model.FormID
...
WriteAttribute("value", Tuple.Create(" value=\"", 7705), Tuple.Create("\"", 7754)
            
            #line 211 "..\..\Views\IsoFormProjSubYSMobile\info.cshtml"
                , Tuple.Create(Tuple.Create("", 7713), Tuple.Create<System.Object, System.Int32>(Model.ColAttDate1.ToString("yyyy-MM-dd")
...
WriteAttribute("value", Tuple.Create(" value=\"", 7981), Tuple.Create("\"", 8030)
            
            #line 215 "..\..\Views\IsoFormProjSubYSMobile\info.cshtml"
                , Tuple.Create(Tuple.Create("", 7989), Tuple.Create<System.Object, System.Int32>(Model.ColAttDate2.ToString("yyyy-MM-dd")
...
WriteLiteral(@">
        ...
        function initFormBegin(params) {
            ...
            #line 256 "..\..\Views\IsoFormProjSubYSMobile\info.cshtml"
          Write(Model.FormID);
...
WriteLiteral(">0)\r\n            {\r\n                $(\"#ProjSubIDs\").val(");
            ...
            #line 258 "..\..\Views\IsoFormProjSubYSMobile\info.cshtml"
                                Write(Model.ProjID);
...
WriteLiteral(");\r\n            }\r\n\r\n            //获取数据\r\n            $.post(\'");
            ...
            #line 262 "..\..\Views\IsoFormProjSubYSMobile\info.cshtml"
...
"r ColAttDate2 = $(\'#ColAttDate2\').val(); //验收日期\r\n           \r\n            if (Co" +
...
"tById(\'IsoFormProjSubYSForm\'));\r\n\r\n            //if (paramsObj.AllowEditControls" +
" == \"{}\") {\r\n            //    $(\'#YSQKJL,#PJJY,#CJYSBM,#CJYSRY,#YSRMQZ,#YSZZ\')." +
"removeClass(\'jq-text-disabled\').addClass(\'aui-input\')\r\n            //    $(\"#YSQ" +
"KJL,#PJJY,#CJYSBM,#CJYSRY,#YSRMQZ,#YSZZ\").css({\r\n            //        overflow:" +
" \'auto\',\r\n\r\n            //    })\r\n            //}\r\n            //else {\r\n       " +
"     //    $(\'#YSQKJL,#PJJY,#CJYSBM,#CJYSRY,#YSRMQZ,#YSZZ\').removeClass(\'jq-text" +
"-disabled\').attr(\"readonly\", \"readonly\")\r\n            //    $(\"#YSQKJL,#PJJY,#CJ" +
"YSBM,#CJYSRY,#YSRMQZ,#YSZZ\").css({\r\n            //        overflow: \'auto\',\r\n   " +
"         //        background: \'#efefef\',\r\n            //        color: \'#898787" +
"\'\r\n            //    })\r\n\r\n            //}\r\n\r\n           \r\n            //验收情况记录\t" +
"，替换换行符\r\n            var YSQKJLValue = $(\'#YSQKJL\').val();\r\n            YSQKJLVal" +
"ue = YSQKJLValue.replace(/[\\r\\n]/g, \"\").replace(/\\s/g, \"\")\r\n            $(\'#YSQK" +
"JL\').val(YSQKJLValue);\r\n\r\n            //评价意见\t，替换换行符\r\n            var PJJYValue =" +
" $(\'#PJJY\').val();\r\n            PJJYValue = PJJYValue.replace(/[\\r\\n]/g, \"\").rep" +
"lace(/\\s/g, \"\")\r\n            $(\'#PJJY\').val(PJJYValue);\r\n\r\n            //参加验收部门，" +
"替换换行符\r\n            var CJYSBMValue = $(\'#CJYSBM\').val();\r\n            CJYSBMValu" +
"e = CJYSBMValue.replace(/[\\r\\n]/g, \"\").replace(/\\s/g, \"\")\r\n            $(\'#CJYSB" +
"M\').val(CJYSBMValue);\r\n\r\n            //参加验收人员，替换换行符\r\n            var CJYSRYValue" +
...
").val($(\"#YLDYJ\").val());\r\n                $(\"#strYSZZ\").val($(\"#YSZZ\").val());\r" +
"\n                var formData = DomUtil.serialize(document.getElementById(\'IsoFo" +
"rmProjSubYSForm\'));//json or =&\r\n                console.log(formData)\r\n        " +
"        //告诉移动端页面初始完完毕\r\n                if (window.JinQuMobile) {\r\n             " +
"       window.JinQuMobile.validateFormEnd(JSON.stringify(formData));\r\n          " +
"      }\r\n            }\r\n        }\r\n\r\n        /*---------------------------------" +
"-------------------------------------------------------------*/\r\n        //不走验证流" +
"程\r\n        function noValidateFormBegin(params) {\r\n            var formData = Do" +
"mUtil.serialize(document.getElementById(\'IsoFormProjSubYSForm\'));//json or =&\r\n " +
"           //告诉移动端页面验证完毕\r\n\r\n            if (window.JinQuMobile) {\r\n             " +
"   window.JinQuMobile.validateFormEnd(JSON.stringify(formData));\r\n            }\r" +
"\n        }\r\n\r\n    </script>\r\n");
