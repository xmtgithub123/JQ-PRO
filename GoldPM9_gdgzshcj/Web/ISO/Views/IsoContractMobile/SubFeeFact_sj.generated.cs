...
namespace ASP
{
    ...
    #line 5 "..\..\Views\IsoContractMobile\SubFeeFact_sj.cshtml"
    using JQ.Web;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/IsoContractMobile/SubFeeFact_sj.cshtml")]
    public partial class _Views_IsoContractMobile_SubFeeFact_sj_cshtml : System.Web.Mvc.WebViewPage<DataModel.Models.IsoForm>
    {
        public _Views_IsoContractMobile_SubFeeFact_sj_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Views\IsoContractMobile\SubFeeFact_sj.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 2963), Tuple.Create("\"", 2984)
            ...
            #line 124 "..\..\Views\IsoContractMobile\SubFeeFact_sj.cshtml"
...
WriteLiteral(">\r\n\r\n        var _webconfig = {\r\n            serverUrl: \'");
            ...
            #line 203 "..\..\Views\IsoContractMobile\SubFeeFact_sj.cshtml"
                   Write(Url.Content("~"));
...
"\r\n            $.post(\'");
            ...
            #line 234 "..\..\Views\IsoContractMobile\SubFeeFact_sj.cshtml"
...
WriteLiteral("\' + \"?CompanyType=SJ\" + \"\", {\r\n                SubFeeFactId:  ");
            ...
            #line 235 "..\..\Views\IsoContractMobile\SubFeeFact_sj.cshtml"
                          Write(Model.FormID);
...
"ate2 = $(\'#ColAttDate2\').val(); //验收日期\r\n\r\n            //if ((ColAttDate1 == \'190" +
"0-01-01\' || ColAttDate2 == \'1900-01-01\' )) {\r\n            //    $(\'#ColAttDate1," +
"#ColAttDate2\').val(\'\');\r\n            //}\r\n\r\n            //设置表单不可编辑样式及只读\r\n       " +
"     $(\'form :input\').addClass(\'jq-text-disabled\').attr(\"readonly\", \"readonly\");" +
"\r\n            DomUtil.setCtrlsReadonly(paramsObj.AllowEditControls, document.get" +
"ElementById(\'BussSubFeeFactForm\'));\r\n\r\n            $(\'#FormNote\').removeClass(\'j" +
"q-text-disabled\').attr(\"readonly\", \"readonly\")\r\n            $(\"#FormNote\").css({" +
"\r\n                overflow: \'auto\',\r\n                background: \'#efefef\',\r\n   " +
"             color: \'#898787\'\r\n            })\r\n\r\n            //备注\t，替换换行符\r\n      " +
...
"ment.getElementById(\'BussSubFeeFactForm\'));//json or =&\r\n                console" +
".log(formData)\r\n                //告诉移动端页面初始完完毕\r\n                if (window.JinQu" +
"Mobile) {\r\n                    window.JinQuMobile.validateFormEnd(JSON.stringify" +
"(formData));\r\n                }\r\n            }\r\n        }\r\n\r\n        /*---------" +
"--------------------------------------------------------------------------------" +
"-----*/\r\n        //不走验证流程\r\n        function noValidateFormBegin(params) {\r\n     " +
"       var formData = DomUtil.serialize(document.getElementById(\'BussSubFeeFactF" +
"orm\'));//json or =&\r\n            //告诉移动端页面验证完毕\r\n            if (window.JinQuMobi" +
