...
namespace ASP
{
    ...
    #line 5 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
    using JQ.Web;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/IsoFormProjSubPFMobile/info_gc.cshtml")]
    public partial class _Views_IsoFormProjSubPFMobile_info_gc_cshtml : System.Web.Mvc.WebViewPage<DataModel.Models.IsoForm>
    {
        public _Views_IsoFormProjSubPFMobile_info_gc_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteLiteral(">");
            ...
            #line 123 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 3048), Tuple.Create("\"", 3069)
            ...
            #line 125 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 5847), Tuple.Create("\"", 5876)
            ...
            #line 187 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 6178), Tuple.Create("\"", 6205)
            ...
            #line 192 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 6430), Tuple.Create("\"", 6456)
            ...
            #line 196 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 6679), Tuple.Create("\"", 6704)
            ...
            #line 200 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 6929), Tuple.Create("\"", 6954)
            ...
            #line 204 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 7183), Tuple.Create("\"", 7211)
            ...
            #line 208 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteLiteral("                ");
            ...
            #line 212 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteLiteral(">&nbsp;&nbsp;&nbsp;&nbsp;(1)服务进度 ");
            ...
            #line 218 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteLiteral(">&nbsp;&nbsp;&nbsp;&nbsp;(2)设计质量 ");
            ...
            #line 219 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteLiteral(">&nbsp;&nbsp;&nbsp;&nbsp;(3)服务态度 ");
            ...
            #line 220 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteLiteral(">&nbsp;&nbsp;&nbsp;&nbsp;(4)总体评价 ");
            ...
            #line 221 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteAttribute("value", Tuple.Create(" value=\"", 8915), Tuple.Create("\"", 8940)
            ...
            #line 234 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
WriteLiteral(@">
        ...
        function initFormBegin(params) {
           //alert(params)
            ...
            #line 259 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
           Write(Model.FormID);
...
WriteLiteral(">0)\r\n            {\r\n                $(\"#ProjSubIDs\").val(");
            ...
            #line 261 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
                                Write(Model.ProjID);
...
WriteLiteral(");\r\n            }\r\n\r\n\r\n            $.post(\'");
            ...
            #line 265 "..\..\Views\IsoFormProjSubPFMobile\info_gc.cshtml"
...
".setCtrlsReadonly(paramsObj.AllowEditControls, document.getElementById(\'IsoFormP" +
"rojSubPFForm\'));\r\n\r\n            $(\'#ConSubNumber,#ConSubFee,#HZSJName,#CustName," +
"#CompanyName\').addClass(\'jq-text-disabled\').attr(\"readonly\", \"readonly\");\r\n\r\n\r\n " +
...
"B\"]\').removeClass(\'jq-text-disabled\').attr(\"disabled\", false)\r\n                $" +
"(\'input[name=\"itemsC\"]\').removeClass(\'jq-text-disabled\').attr(\"disabled\", false)" +
"\r\n                $(\'input[name=\"itemsD\"]\').removeClass(\'jq-text-disabled\').attr" +
"(\"disabled\", false)\r\n\r\n            }\r\n            else {\r\n                // ale" +
"rt(\'ok1\')\r\n                $(\'input[name=\"items\"]\').addClass(\'jq-text-disabled\')" +
".attr(\"disabled\", \"disabled\")\r\n                $(\'input[name=\"itemsA\"]\').addClas" +
"s(\'jq-text-disabled\').attr(\"disabled\", \"disabled\")\r\n                $(\'input[nam" +
"e=\"itemsB\"]\').addClass(\'jq-text-disabled\').attr(\"disabled\", \"disabled\")\r\n       " +
"         $(\'input[name=\"itemsC\"]\').addClass(\'jq-text-disabled\').attr(\"disabled\"," +
" \"disabled\")\r\n                $(\'input[name=\"itemsD\"]\').addClass(\'jq-text-disabl" +
"ed\').attr(\"disabled\", \"disabled\")\r\n\r\n            }\r\n\r\n            //备注，替换换行符\r\n  " +
"          var BZValue = $(\'#BZ\').val();\r\n            BZValue = BZValue.replace(/" +
"[\\r\\n]/g, \"\")\r\n            $(\'#BZ\').val(BZValue);\r\n\r\n            if (paramsObj.A" +
"llowEditControls == \"{}\") {\r\n                $(\'#BZ\').removeClass(\'jq-text-disab" +
"led\').addClass(\'aui-input\')\r\n                $(\"#BZ\").css({\r\n                   " +
" overflow: \'auto\',\r\n\r\n                })\r\n            }\r\n            else {\r\n   " +
...
"}\r\n        }\r\n        /*--------------------------------------------------------" +
"--------------------------------------*/\r\n        //表单验证交互\r\n        function val" +
"idateFormBegin() {\r\n            var formVali = $(\'#IsoFormProjSubPFForm\').valida" +
"te({\r\n                rules: {\r\n\r\n                },\r\n                messages: " +
"{\r\n\r\n                }\r\n            });\r\n            isValidate = formVali.form(" +
");\r\n            if (isValidate) {\r\n\r\n\r\n                //1\r\n                var " +
"wfxdIdArr = [];\r\n                $(\'#WFXD input[type=\"checkbox\"]:checked\').each(" +
"function (i, e) {\r\n                    console.log($(this).val())\r\n             " +
"       wfxdIdArr.push($(this).val())\r\n                })\r\n                $(\'#st" +
"ritems\').val(wfxdIdArr)\r\n\r\n                //2\r\n                var fwjdIdArr = " +
"[];\r\n                $(\'#FWJD input[type=\"checkbox\"]:checked\').each(function (i," +
" e) {\r\n                    fwjdIdArr.push($(this).val())\r\n                })\r\n  " +
"              $(\'#stritemsA\').val(fwjdIdArr)\r\n\r\n                //3\r\n           " +
"     var sjzlIdArr = [];\r\n                $(\'#SJZL input[type=\"checkbox\"]:checke" +
"d\').each(function (i, e) {\r\n                    sjzlIdArr.push($(this).val())\r\n " +
"               })\r\n                $(\'#stritemsB\').val(fwjdIdArr)\r\n\r\n           " +
"     //4\r\n                var fwtdIdArr = [];\r\n                $(\'#FWTD input[ty" +
"pe=\"checkbox\"]:checked\').each(function (i, e) {\r\n                    fwtdIdArr.p" +
"ush($(this).val())\r\n                })\r\n                $(\'#stritemsC\').val(fwtd" +
"IdArr)\r\n\r\n                //5\r\n                var ztpjIdArr = [];\r\n            " +
...
"onsole.log(formData)\r\n                //告诉移动端页面初始完完毕\r\n                if (window" +
".JinQuMobile) {\r\n                    window.JinQuMobile.validateFormEnd(JSON.str" +
"ingify(formData));\r\n                }\r\n            }\r\n        }\r\n\r\n\r\n        /*-" +
"--------------------------------------------------------------------------------" +
"-------------*/\r\n        //不走验证流程\r\n        function noValidateFormBegin(params) " +
"{\r\n\r\n            //1\r\n            var wfxdIdArr = [];\r\n            $(\'#WFXD inpu" +
"t[type=\"checkbox\"]:checked\').each(function (i, e) {\r\n                console.log" +
"($(this).val())\r\n                wfxdIdArr.push($(this).val())\r\n            })\r\n" +
"            $(\'#stritems\').val(wfxdIdArr)\r\n\r\n            //2\r\n            var fw" +
"jdIdArr = [];\r\n            $(\'#FWJD input[type=\"checkbox\"]:checked\').each(functi" +
"on (i, e) {\r\n                fwjdIdArr.push($(this).val())\r\n            })\r\n    " +
"        $(\'#stritemsA\').val(fwjdIdArr)\r\n\r\n            //3\r\n            var sjzlI" +
"dArr = [];\r\n            $(\'#SJZL input[type=\"checkbox\"]:checked\').each(function " +
"(i, e) {\r\n                sjzlIdArr.push($(this).val())\r\n            })\r\n       " +
"     $(\'#stritemsB\').val(fwjdIdArr)\r\n\r\n            //4\r\n            var fwtdIdAr" +
"r = [];\r\n            $(\'#FWTD input[type=\"checkbox\"]:checked\').each(function (i," +
" e) {\r\n                fwtdIdArr.push($(this).val())\r\n            })\r\n          " +
"  $(\'#stritemsC\').val(fwtdIdArr)\r\n\r\n            //5\r\n            var ztpjIdArr =" +
" [];\r\n            $(\'#ZJPJ input[type=\"checkbox\"]:checked\').each(function (i, e)" +
" {\r\n                ztpjIdArr.push($(this).val())\r\n            })\r\n            $" +
"(\'#stritemsD\').val(ztpjIdArr)\r\n\r\n            var formData = DomUtil.serialize(do" +
"cument.getElementById(\'IsoFormProjSubPFForm\'));//json or =&\r\n            //告诉移动端" +
