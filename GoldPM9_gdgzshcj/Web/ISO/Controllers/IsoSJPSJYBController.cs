...
{
[Description("IsoSJPSJYB")]
public class IsoSJPSJYBController : CoreController
    {
        ...
        public string json()
        {
            ...
            var There = QueryBuild<DataModel.Models.IsoSJPSJYB>.True();
            ...
            var showList = (from p in list
                            join t1 in op.DbContext.Set<DataModel.Models.Flow>().Where(f => f.FlowRefTable == "IsoSJPSJYB") on p.Id equals t1.FlowRefID into nodes
        ...
        public ActionResult del(int[] id)
        {
            ...
            try
            {
                ...
                new DBSql.PubFlow.Flow().Delete(id, "IsoSJPSJYB");
                using (var ba = new DBSql.Sys.BaseAttach())
                {
                    ba.Delete(id, "IsoSJPSJYB");
                }
