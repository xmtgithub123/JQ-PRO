...
{
[Description("IsoZYZDJYB")]
public class IsoZYZDJYBController : CoreController
    {
        ...
        public string json()
        {
            ...
            var There = QueryBuild<DataModel.Models.IsoZYZDJYB>.True();
            ...
            var showList = (from p in list
                            join t1 in op.DbContext.Set<DataModel.Models.Flow>().Where(f => f.FlowRefTable == "IsoZYZDJYB") on p.Id equals t1.FlowRefID into nodes
        ...
        {
            ViewBag.CurrEmpID = userInfo.EmpID;
            var model = new IsoZYZDJYB();
            model.TableNumber = "SCX02-12";
        ...
        public ActionResult del(int[] id)
        {
            ...
            try
            {
                ...
                new DBSql.PubFlow.Flow().Delete(id, "IsoZYZDJYB");
                using (var ba = new DBSql.Sys.BaseAttach())
                {
                    ba.Delete(id, "IsoZYZDJYB");
                }
