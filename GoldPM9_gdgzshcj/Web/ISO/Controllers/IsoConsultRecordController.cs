...
{
[Description("IsoConsultRecord")]
public class IsoConsultRecordController : CoreController
    {
        ...
        public string json()
        {
            ...
            var Thwere = QueryBuild<DataModel.Models.IsoConsultRecord>.True();
            ...
            var showList = (from p in list
                            join t1 in op.DbContext.Set<DataModel.Models.Flow>().Where(f => f.FlowRefTable == "IsoConsultRecord") on p.Id equals t1.FlowRefID into nodes
                            ...
                            select new
                            {
                                ...
                                BuildCompany = p.BuildCompany,
                                SupervisonCompany = p.SupervisonCompany,
                                ConstructionCompany = p.ConstructionCompany,
                                ConstructionDate = p.ConstructionDate,
                                ReviewerDate = p.ReviewerDate,
                                p.CreatorEmpId,
        ...
        {
            var model = new IsoConsultRecord();

            ViewBag.CreateEmpId = userInfo.EmpID;
            model.TableNumber = "SCX04-02";
        ...
        public ActionResult del(int[] id)
        {
            ...
            try
            {
                ...
                new DBSql.PubFlow.Flow().Delete(id, "IsoConsultRecord");
                using (var ba = new DBSql.Sys.BaseAttach())
                {
                    ba.Delete(id, "IsoConsultRecord");
                }
