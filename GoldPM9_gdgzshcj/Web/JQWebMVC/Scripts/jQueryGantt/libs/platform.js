...
function createBlackPage(width, height, onCloseCallBack) {
    ...
    var bg = $("<div>").attr("id", "__blackpopup__");
    bg.css({ position: 'fixed', top: "0px", paddingTop: "50px", left: 0, width: '100%', height: '100%', backgroundImage: "url('/JQWebMVC/Scripts/jQueryGantt/res/black_701.png')" });
    ...
    var img = $("<img src='/JQWebMVC/Scripts/jQueryGantt/res/closeBig.png' style='cursor:pointer;position:absolute;right:-40px;top:5px;' title='close'>");
    bdiv.append(img);
    img.click(function () {
        bg.trigger("close");
    });
