...
(function (root, factory) {
    ...
    var g = (function () {
        ...
        var bezier = {
            ...
            // a parametric curve x = x(t)/w(t), y = y(t)/w(t), 铿乶d the parameter value t
    ...
    // Copyright 漏 2012 - 2015 client IO (http://client.io)
        ...
        util: {
            ...
            format: {
                ...
                prefix: function (value, precision) {
                    ...
                    var prefixes = _.map(['y', 'z', 'a', 'f', 'p', 'n', '碌', 'm', '', 'k', 'M', 'G', 'T', 'P', 'E', 'Z', 'Y'], function (d, i) {
    ...
    joint.dia.Element = joint.dia.Cell.extend({
        ...
        translate: function (tx, ty, opt) {
            ...
            if (opt.restrictedArea && opt.translateBy === this.id) {
                ...
                // -> bbox.x
                //                鈻撯枔鈻撯枔鈻撯枔鈻�   |
                //         鈻戔枒鈻戔枒鈻戔枒鈻戔枔鈻撯枔鈻撯枔鈻撯枔
                //         鈻戔枒鈻戔枒鈻戔枒鈻戔枒鈻�        |
                //   鈻撯枔鈻撯枔鈻撯枔鈻撯枔鈻戔枒鈻戔枒鈻戔枒鈻�
                //   鈻撯枔鈻撯枔鈻撯枔鈻撯枔               |
                //   <-dx->                     | restricted area right border
                //         <-width->        |   鈻� translated element
                //   <- - bbox.width - ->       鈻� embedded element
