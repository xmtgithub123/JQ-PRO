...
(function ($) {
    ...
    function _135(_136, ul, _137, _138) {
        ...
        var _13a = $(ul).prev().children("span.fa-folder");
    ...
    function _157(_158, _159) {
        ...
        if (node.length == 0) {
            ...
            if (_11b(_158, node[0])) {
                ...
                _15a.removeClass("tree-file").addClass("fa-folder fa-folder-open");
    ...
    function _160(_161, _162) {
        ...
        if (_163) {
            if (!_163.children || !_163.children.length) {
                ...
                node.find(".tree-icon").removeClass("fa-folder").addClass("tree-file");
            ...
            function _1c5(_1c6, _1c7) {
                ...
                for (var i = 0; i < _1c7.length; i++) {
                    ...
                    if (item.state == "closed") {
                        ...
                        cc.push("<span class=\"tree-icon fa-folder " + (item.iconCls ? item.iconCls : "") + "\"></span>");
                    } else {
                        if (item.children && item.children.length) {
                            cc.push("<span class=\"tree-hit tree-expanded\"></span>");
                            cc.push("<span class=\"tree-icon fa-folder fa-folder-open " + (item.iconCls ? item.iconCls : "") + "\"></span>");
                        } else {
                            cc.push("<span class=\"tree-indent\"></span>");
                            if (item.iconCls && item.iconCls != null && item.iconCls.length > 0) {
                                cc.push("<span class=\"tree-icon " + item.iconCls + "\"></span>");
                            }
                            else {
                                cc.push("<span class=\"tree-icon tree-file\"></span>");
                            }
        ...
        function _221() {
            if (opts.noheader || (!opts.title && !opts.header)) {
                ...
                if (opts.header) {
                    ...
                    _225.empty();
                    var _226 = $("<div class=\"panel-title\" style=\"padding-right:58px;text-overflow:ellipsis;overflow:hidden;height:100%;white-space:nowrap\"></div>").html(opts.title).appendTo(_225);
                    if (opts.iconCls) {
...
(function ($) {
    ...
    $.fn.textbox.defaults = $.extend({}, $.fn.validatebox.defaults, {
        width: "auto", height: 28, prompt: "", value: "", type: "text", multiline: false, editable: true, disabled: false, readonly: false, icons: [], iconCls: null, iconAlign: "right", iconWidth: 18, buttonText: "", buttonIcon: null, buttonAlign: "right", inputEvents: {
            blur: function (e) {
                var t = $(e.data.target);
...
(function ($) {
    ...
    function _647(_680, data) {
        ...
        opts.view.onLoadSuccess && opts.view.onLoadSuccess.call(_680, data, opts, "datagrid");
    };
    function _687(_688) {
    ...
    var _77a = {
        render: function (_77b, _77c, _77d) {
            ...
            //opts.onFlowUpdateRow && opts.onFlowUpdateRow.call(_79a, _79b, "datagrid");
            ...
            function _7b8(_7b9) {
                var _7ba = _7b9 ? 1 : 2;
                for (var i = parseInt(_7b6) + 1; i < data.rows.length; i++) {
            ...
            if (opts.finder.getRows(_7bd).length == 0) {
                this.renderEmptyRow && this.renderEmptyRow(_7bd);
            }
...
(function ($) {
    ...
    function _873(_874, _875, data, _876) {
        ...
        opts.view.onLoadSuccess && opts.view.onLoadSuccess.call(_874, data, opts, "treegrid");
    };
    function _85c(_87c, _87d, _87e, _87f, _880) {
        ...
        var _882 = body.find("tr[node-id=\"" + _87d + "\"] span.fa-folder");
    ...
    function _8ae(_8af, _8b0) {
        ...
        if (_8b0.parent) {
            ...
            if (_8b1.hasClass("tree-file")) {
                _8b1.removeClass("tree-file").addClass("fa-folder fa-folder-open");
    ...
    var _8d6 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_8d7, _8d8, _8d9) {
                ...
                if (col) {
                    ...
                    if (col.checkbox) {
                        ...
                        if (_8f1 == opts.treeField) {
                            ...
                            if (row.state == "closed") {
                                cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
                                cc.push("<span class=\"tree-icon fa-folder " + (row.iconCls ? row.iconCls : "") + "\"></span>");
                            } else {
                                if (row.children && row.children.length) {
                                    cc.push("<span class=\"tree-hit tree-expanded\"></span>");
                                    cc.push("<span class=\"tree-icon fa-folder fa-folder-open " + (row.iconCls ? row.iconCls : "") + "\"></span>");
                                } else {
                                    cc.push("<span class=\"tree-indent\"></span>");
            ...
            //opts.onFlowUpdateRow && opts.onFlowUpdateRow.call(_8f6, id, "treegrid");
            ...
            if (_902) {
                if (_902.children.length == 0) {
                    ...
                    tr.next("tr.treegrid-tr-tree").remove();
                    var cell = tr.children("td[field=\"" + opts.treeField + "\"]").children("div.datagrid-cell");
                    cell.find(".tree-icon").removeClass("fa-folder").addClass("tree-file");
