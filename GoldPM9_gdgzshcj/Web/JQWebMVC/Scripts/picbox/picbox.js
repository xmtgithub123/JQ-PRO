...
(function ($) {
	...
	iebrowser = $.support.msie && (($.support.version == "6.0") || ($.support.version == "7.0") || ($.support.version == "8.0")),
	...
	*/
    ...
    function setup(open) {
        ...
        //$(document).mousewheel(scrollZoom);
    ...
    function scrollZoom(e, delta) {
        ...
        var to = currentSize + ((e.originalEvent.wheelDelta / 120) * currentSize / 10);
    ...
    //    if (event.originalEvent.wheelDelta) delta = event.originalEvent.wheelDelta / 120;//jq 1.11.3版本中使用
    ...
    //    return $.event.handler.apply(this, args);
