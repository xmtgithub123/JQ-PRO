...
//此代码由T4模板自动生成
//生成时间 2017-05-08 19:00:43
#endregion
using System;
using System.Collections.Generic;
namespace DataModel.Models
{
    public class IsoGCDZKCTJDJZ
    {
        public IsoGCDZKCTJDJZ()
        {
			#region DefaultValue
			Id=0;
			TableNumber="";
		...
		///<summary>勘察工作要求</summary>
        public string KCGZYQ  { get; set; }

		///<summary>附图</summary>
        public string FTSM  { get; set; }

		///<summary>成果要求内容</summary>
        public string CGYQ  { get; set; }
