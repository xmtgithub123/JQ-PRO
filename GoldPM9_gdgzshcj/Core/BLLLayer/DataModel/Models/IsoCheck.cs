...
namespace DataModel.Models
{
    public class IsoCheck 
    {
		...
		///<summary>差错排查实际表</summary>
        public int Id  { get; set; }

		///<summary>任务节点表</summary>
        public long DesTaskId  { get; set; }

		///<summary>差错模版表</summary>
        public int IsoCheckModelId  { get; set; }
		...
		public virtual DesTask FK_IsoCheck_DesTaskId { get; set; }
public virtual ModelIsoCheck FK_IsoCheck_IsoCheckModelId { get; set; }
    }
}
