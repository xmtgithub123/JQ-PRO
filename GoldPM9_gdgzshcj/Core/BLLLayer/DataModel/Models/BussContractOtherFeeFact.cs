...
{
    public class BussContractOtherFeeFact 
    {
        public BussContractOtherFeeFact()
        {
			#region DefaultValue
			Id=0;
			FeerDate= new DateTime(1900,1,1);
			FeeMoney=0;
			FeeNote="";
			RefID=0;
			RefTable="";
		...
		///<summary>收款/付款日期</summary>
        public DateTime FeerDate  { get; set; }

		///<summary>收款/付款金额(元)</summary>
        ...
        /// <summary>
        /// 所属公司 0分工 1设计公司 2工程公司
        /// </summary>
        public int CompanyID { get; set; }

		public virtual BaseData FK_BussContractOtherFeeFact_FactTypeID { get; set; }
public virtual BussContractOther FK_BussContractOtherFeeFact_RefID { get; set; }
    }
}
