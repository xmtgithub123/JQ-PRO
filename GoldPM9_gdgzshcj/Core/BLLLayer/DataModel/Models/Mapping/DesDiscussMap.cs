...
{
public class DesDiscussMap : EntityTypeConfiguration<DesDiscuss>
    {
        public DesDiscussMap()
        {
			...
			this.Property(t => t.TalkRefId).IsRequired();
	  
			this.Property(t => t.TalkRefTable).IsRequired().HasMaxLength(200);
	  
			this.Property(t => t.TalkGroupId).IsRequired();
	  
			this.Property(t => t.TalkTitle).IsRequired().HasMaxLength(2000);
	  
			this.Property(t => t.TalkContent).IsRequired().HasMaxLength(4000);
	  
			this.Property(t => t.ReadCount).IsRequired();
	  
			this.Property(t => t.ReplyCount).IsRequired();
	  
			this.Property(t => t.LastReplyEmpName).IsRequired().HasMaxLength(200);
	  
			this.Property(t => t.LastReplyTime).IsRequired();


			 // Table & Column Mappings
			this.ToTable("DesDiscuss");
			...
			this.Property(t => t.TalkRefId).HasColumnName("TalkRefId");
			this.Property(t => t.TalkRefTable).HasColumnName("TalkRefTable");
			this.Property(t => t.TalkGroupId).HasColumnName("TalkGroupId");
			this.Property(t => t.TalkTitle).HasColumnName("TalkTitle");
			...
			this.Property(t => t.LastReplyEmpName).HasColumnName("LastReplyEmpName");
			this.Property(t => t.LastReplyTime).HasColumnName("LastReplyTime");
