...
//此代码由T4模板自动生成 
//生成时间 2017-04-19 13:51:24
#endregion
using System.ComponentModel.DataAnnotations.Schema;
using System.Data.Entity.ModelConfiguration;
namespace DataModel.Models.Mapping
{
public class IsoBGSJRWTZDMap : EntityTypeConfiguration<IsoBGSJRWTZD>
    {
        public IsoBGSJRWTZDMap()
        {
			...
			this.Property(t => t.ChangeTaskType).IsRequired().HasMaxLength(1000);
			...
			this.Property(t => t.ChangeTaskType).HasColumnName("ChangeTaskType");
