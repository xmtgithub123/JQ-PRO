...
//此代码由T4模板自动生成 
//生成时间 2017-04-18 15:51:08
#endregion
using System.ComponentModel.DataAnnotations.Schema;
using System.Data.Entity.ModelConfiguration;
namespace DataModel.Models.Mapping
{
public class IsoDWGZLXDMap : EntityTypeConfiguration<IsoDWGZLXD>
    {
        public IsoDWGZLXDMap()
        {
			...
			this.Property(t => t.ZhuTi).IsRequired().HasMaxLength(1000);
	  
			this.Property(t => t.ZhuSong).IsRequired().HasMaxLength(1000);
	  
			this.Property(t => t.ChaoSong).IsRequired().HasMaxLength(1000);
	  
			this.Property(t => t.SignTime).IsRequired();
	  
			this.Property(t => t.Contents).IsRequired().HasMaxLength(4000);
	  
			this.Property(t => t.AcceptUnit).IsRequired().HasMaxLength(4000);
	  
			this.Property(t => t.AcceptPerson).IsRequired().HasMaxLength(50);
	  
			this.Property(t => t.AcceptTime).IsRequired();
			...
			this.Property(t => t.ZhuTi).HasColumnName("ZhuTi");
			this.Property(t => t.ZhuSong).HasColumnName("ZhuSong");
			this.Property(t => t.ChaoSong).HasColumnName("ChaoSong");
			this.Property(t => t.SignTime).HasColumnName("SignTime");
			this.Property(t => t.Contents).HasColumnName("Contents");
			this.Property(t => t.AcceptUnit).HasColumnName("AcceptUnit");
			this.Property(t => t.AcceptPerson).HasColumnName("AcceptPerson");
			this.Property(t => t.AcceptTime).HasColumnName("AcceptTime");
