...
{
public class OaStampLendMap : EntityTypeConfiguration<OaStampLend>
    {
        public OaStampLendMap()
        {
			this.HasKey(t => new { t.Id}); 
				  
			this.Property(t => t.StampID).IsRequired();
	  
			this.Property(t => t.StampLendDate).IsRequired();
	  
			this.Property(t => t.StampLendNote).IsRequired().HasMaxLength(500);
	  
			this.Property(t => t.StampPlanReturnDate).IsRequired();
	  
			this.Property(t => t.StampFactReturnDate).IsRequired();
	  
			this.Property(t => t.StampReturnEmpId).IsRequired();
	  
			this.Property(t => t.StampReturnEmpName).IsRequired().HasMaxLength(50);
			...
			this.Property(t => t.OaStampUseId).IsRequired();


			 // Table & Column Mappings
			this.ToTable("OaStampLend");
			this.Property(t => t.Id).HasColumnName("Id");
			this.Property(t => t.StampID).HasColumnName("StampID");
			this.Property(t => t.StampLendDate).HasColumnName("StampLendDate");
			this.Property(t => t.StampLendNote).HasColumnName("StampLendNote");
			this.Property(t => t.StampPlanReturnDate).HasColumnName("StampPlanReturnDate");
			this.Property(t => t.StampFactReturnDate).HasColumnName("StampFactReturnDate");
			this.Property(t => t.StampReturnEmpId).HasColumnName("StampReturnEmpId");
			this.Property(t => t.StampReturnEmpName).HasColumnName("StampReturnEmpName");
			...
			this.Property(t => t.OaStampUseId).HasColumnName("OaStampUseId");
			           
			#region Relationships
			this.HasRequired(t => t.FK_OaStampLend_StampID).WithMany(t => t.FK_OaStampLend_StampID).HasForeignKey(d => d.StampID);
			#endregion
        }
    }
}  
