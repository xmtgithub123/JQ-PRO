...
{
public class DesEventMap : EntityTypeConfiguration<DesEvent>
    {
        public DesEventMap()
        {
			...
			this.Property(t => t.EventRefId).IsRequired();
	  
			this.Property(t => t.EventRefTable).IsRequired().HasMaxLength(200);
	  
			this.Property(t => t.EventGroupId).IsRequired();
	  
			this.Property(t => t.EventTitle).IsRequired().HasMaxLength(2000);
	  
			this.Property(t => t.EventContent).IsRequired().HasMaxLength(4000);
	  
			this.Property(t => t.ProjId).IsRequired();


			 // Table & Column Mappings
			this.ToTable("DesEvent");
			...
			this.Property(t => t.EventRefTable).HasColumnName("EventRefTable");
			this.Property(t => t.EventGroupId).HasColumnName("EventGroupId");
