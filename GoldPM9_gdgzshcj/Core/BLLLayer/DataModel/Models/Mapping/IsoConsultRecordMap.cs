...
//此代码由T4模板自动生成 
//生成时间 2017-04-20 18:05:47
#endregion
using System.ComponentModel.DataAnnotations.Schema;
using System.Data.Entity.ModelConfiguration;
namespace DataModel.Models.Mapping
{
public class IsoConsultRecordMap : EntityTypeConfiguration<IsoConsultRecord>
    {
        public IsoConsultRecordMap()
        {
            ...
            this.Property(t => t.Consultation).IsRequired().HasMaxLength(2000);
	  
			this.Property(t => t.BuildCompany).IsRequired().HasMaxLength(100);
	  
			this.Property(t => t.SupervisonCompany).IsRequired().HasMaxLength(100);
	  
			this.Property(t => t.ConstructionCompany).IsRequired().HasMaxLength(100);
	  
			this.Property(t => t.ConstructionDate).IsRequired();
	  
			this.Property(t => t.SpecialtyDate).IsRequired();
	  
			this.Property(t => t.ReviewerDate).IsRequired();
            ...
            this.Property(t => t.ConstructionPerson).IsRequired().HasMaxLength(50);

            this.Property(t => t.SpecialtyPerson).IsRequired().HasMaxLength(50);

            this.Property(t => t.Reviewer).IsRequired().HasMaxLength(50);


            // Table & Column Mappings
            this.ToTable("IsoConsultRecord");
			...
			this.Property(t => t.BuildCompany).HasColumnName("BuildCompany");
			this.Property(t => t.SupervisonCompany).HasColumnName("SupervisonCompany");
			...
			this.Property(t => t.SpecialtyDate).HasColumnName("SpecialtyDate");
			this.Property(t => t.ReviewerDate).HasColumnName("ReviewerDate");
			...
			this.Property(t => t.ConstructionPerson).HasColumnName("ConstructionPerson");
