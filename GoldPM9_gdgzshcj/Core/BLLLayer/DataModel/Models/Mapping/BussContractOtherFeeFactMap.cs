...
{
public class BussContractOtherFeeFactMap : EntityTypeConfiguration<BussContractOtherFeeFact>
    {
        public BussContractOtherFeeFactMap()
        {
			this.HasKey(t => new { t.Id}); 
				  
			this.Property(t => t.FeerDate).IsRequired();
			...
			this.Property(t => t.FactTypeID).IsRequired();
            ...
            this.ToTable("BussContractOtherFeeFact");
			this.Property(t => t.Id).HasColumnName("Id");
			this.Property(t => t.FeerDate).HasColumnName("FeerDate");
			...
			this.Property(t => t.FactTypeID).HasColumnName("FactTypeID");
            ...
            this.HasRequired(t => t.FK_BussContractOtherFeeFact_FactTypeID).WithMany(t => t.FK_BussContractOtherFeeFact_FactTypeID).HasForeignKey(d => d.FactTypeID);
			this.HasRequired(t => t.FK_BussContractOtherFeeFact_RefID).WithMany(t => t.FK_BussContractOtherFeeFact_RefID).HasForeignKey(d => d.RefID);
			#endregion
        }
    }
}  
