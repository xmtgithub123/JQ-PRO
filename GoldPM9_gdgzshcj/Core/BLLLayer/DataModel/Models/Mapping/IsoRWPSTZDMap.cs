...
//此代码由T4模板自动生成 
//生成时间 2017-04-20 10:27:02
#endregion
using System.ComponentModel.DataAnnotations.Schema;
using System.Data.Entity.ModelConfiguration;
namespace DataModel.Models.Mapping
{
public class IsoRWPSTZDMap : EntityTypeConfiguration<IsoRWPSTZD>
    {
        public IsoRWPSTZDMap()
        {
			...
			this.Property(t => t.ProjectClass).IsRequired().HasMaxLength(4000);
	  
			this.Property(t => t.AppraisalWay).IsRequired().HasMaxLength(4000);
			...
			this.Property(t => t.DataRequire).IsRequired().HasMaxLength(4000);
	  
			this.Property(t => t.AppraisalContens).IsRequired();
			...
			this.Property(t => t.ProjectClass).HasColumnName("ProjectClass");
			this.Property(t => t.AppraisalWay).HasColumnName("AppraisalWay");
			...
			this.Property(t => t.DataRequire).HasColumnName("DataRequire");
			this.Property(t => t.AppraisalContens).HasColumnName("AppraisalContens");
