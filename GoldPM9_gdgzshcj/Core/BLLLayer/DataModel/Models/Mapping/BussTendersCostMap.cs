...
{
public class BussTendersCostMap : EntityTypeConfiguration<BussTendersCost>
    {
        public BussTendersCostMap()
        {
			this.HasKey(t => new { t.Id}); 
				  
			this.Property(t => t.BussTendersInfoID).IsRequired();
	  
			this.Property(t => t.BussTendersInfoDetailID).IsRequired();
			...
			this.ToTable("BussTendersCost");
			this.Property(t => t.Id).HasColumnName("Id");
			this.Property(t => t.BussTendersInfoID).HasColumnName("BussTendersInfoID");
			this.Property(t => t.BussTendersInfoDetailID).HasColumnName("BussTendersInfoDetailID");
			...
			this.HasRequired(t => t.FK_BussTendersCost_BussTendersInfoDetailID).WithMany(t => t.FK_BussTendersCost_BussTendersInfoDetailID).HasForeignKey(d => d.BussTendersInfoDetailID);
			this.HasRequired(t => t.FK_BussTendersCost_BussTendersInfoID).WithMany(t => t.FK_BussTendersCost_BussTendersInfoID).HasForeignKey(d => d.BussTendersInfoID);
			#endregion
        }
    }
}  
