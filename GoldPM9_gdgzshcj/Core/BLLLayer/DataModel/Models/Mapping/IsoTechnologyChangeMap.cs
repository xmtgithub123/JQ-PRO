...
//此代码由T4模板自动生成 
//生成时间 2017-04-21 10:32:39
#endregion
using System.ComponentModel.DataAnnotations.Schema;
using System.Data.Entity.ModelConfiguration;
namespace DataModel.Models.Mapping
{
public class IsoTechnologyChangeMap : EntityTypeConfiguration<IsoTechnologyChange>
    {
        public IsoTechnologyChangeMap()
        {
            ...
            this.Property(t => t.ApplicationType).IsRequired().HasMaxLength(50);
	  
			this.Property(t => t.ApplicationResult).IsRequired().HasMaxLength(4000);
	  
			this.Property(t => t.ApplicationCompany).IsRequired().HasMaxLength(4000);
	  
			this.Property(t => t.ApplicationPerson).IsRequired().HasMaxLength(50);
	  
			this.Property(t => t.ApplicationDate).IsRequired();
	  
			this.Property(t => t.DesignPerson).IsRequired().HasMaxLength(50);
	  
			this.Property(t => t.SpecialtyPerson).IsRequired().HasMaxLength(50);
	  
			this.Property(t => t.BluePrintPerson).IsRequired().HasMaxLength(50);
	  
			this.Property(t => t.BaseMapPerson).IsRequired().HasMaxLength(50);
	  
			this.Property(t => t.ElectrionPerson).IsRequired().HasMaxLength(50);
			...
			this.ToTable("IsoTechnologyChange");
			...
			this.Property(t => t.ApplicationResult).HasColumnName("ApplicationResult");
			this.Property(t => t.ApplicationCompany).HasColumnName("ApplicationCompany");
			this.Property(t => t.ApplicationPerson).HasColumnName("ApplicationPerson");
			this.Property(t => t.ApplicationDate).HasColumnName("ApplicationDate");
			this.Property(t => t.DesignPerson).HasColumnName("DesignPerson");
			this.Property(t => t.SpecialtyPerson).HasColumnName("SpecialtyPerson");
			this.Property(t => t.BluePrintPerson).HasColumnName("BluePrintPerson");
			this.Property(t => t.BaseMapPerson).HasColumnName("BaseMapPerson");
			this.Property(t => t.ElectrionPerson).HasColumnName("ElectrionPerson");
