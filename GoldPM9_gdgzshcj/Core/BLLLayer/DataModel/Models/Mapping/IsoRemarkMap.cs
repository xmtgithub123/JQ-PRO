...
{
public class IsoRemarkMap : EntityTypeConfiguration<IsoRemark>
    {
        public IsoRemarkMap()
        {
			...
			this.Property(t => t.Address).IsRequired().HasMaxLength(100);
	  
			this.Property(t => t.UnitEmpName).IsRequired().HasMaxLength(100);
			...
			this.Property(t => t.UnitEmpName).HasColumnName("UnitEmpName");
