...
{
public class OaFileReceiveMap : EntityTypeConfiguration<OaFileReceive>
    {
        public OaFileReceiveMap()
        {
			...
			this.Property(t => t.OaFileSend).IsRequired().HasMaxLength(200);
	  
			this.Property(t => t.OaFileGetEmp).IsRequired();
	  
			this.Property(t => t.OaFileGetEmpDept).IsRequired().HasMaxLength(200);
	  
			this.Property(t => t.OaFileGetNote).IsRequired().HasMaxLength(500);
			...
			this.Property(t => t.OaFileSend).HasColumnName("OaFileSend");
			...
			this.Property(t => t.OaFileGetNote).HasColumnName("OaFileGetNote");
