...
{
public class PayModelMap : EntityTypeConfiguration<PayModel>
    {
        public PayModelMap()
        {
			...
			this.Property(t => t.EngPhaseID).IsRequired();
	  
			this.Property(t => t.EngVolID).IsRequired();
	  
			this.Property(t => t.ModelXML).IsRequired();
	  
			this.Property(t => t.ModelIsDeleted).IsRequired();
			...
			this.ToTable("PayModel");
			this.Property(t => t.Id).HasColumnName("Id");
			this.Property(t => t.ModelName).HasColumnName("ModelName");
			this.Property(t => t.EngPhaseID).HasColumnName("EngPhaseID");
			this.Property(t => t.EngVolID).HasColumnName("EngVolID");
			this.Property(t => t.ModelXML).HasColumnName("ModelXML");
			this.Property(t => t.ModelIsDeleted).HasColumnName("ModelIsDeleted");
			...
			this.HasRequired(t => t.FK_PayModel_EngPhaseID).WithMany(t => t.FK_PayModel_EngPhaseID).HasForeignKey(d => d.EngPhaseID);
			this.HasRequired(t => t.FK_PayModel_EngVolID).WithMany(t => t.FK_PayModel_EngVolID).HasForeignKey(d => d.EngVolID);
			#endregion
        }
    }
}  
