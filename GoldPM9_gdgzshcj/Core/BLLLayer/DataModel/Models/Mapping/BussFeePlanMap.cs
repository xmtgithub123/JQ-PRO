...
{
public class BussFeePlanMap : EntityTypeConfiguration<BussFeePlan>
    {
        public BussFeePlanMap()
        {
			this.HasKey(t => new { t.Id}); 
				  
			this.Property(t => t.FeeMoney).IsRequired().HasPrecision(18,4);
	  
			this.Property(t => t.FeeType).IsRequired();
			...
			this.Property(t => t.IsFinished).IsRequired();
			...
			this.HasRequired(t => t.FK_BussFeePlan_ConID).WithMany(t => t.FK_BussFeePlan_ConID).HasForeignKey(d => d.ConID);
			#endregion
        }
    }
}  
