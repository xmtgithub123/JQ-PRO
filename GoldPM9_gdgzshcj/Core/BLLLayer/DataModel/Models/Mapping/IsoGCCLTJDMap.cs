...
//此代码由T4模板自动生成
//生成时间 2017-05-08 15:37:21
#endregion
using System.ComponentModel.DataAnnotations.Schema;
using System.Data.Entity.ModelConfiguration;
namespace DataModel.Models.Mapping
{
public class IsoGCCLTJDMap : EntityTypeConfiguration<IsoGCCLTJD>
    {
        public IsoGCCLTJDMap()
        {
			this.HasKey(t => new { t.Id});
				...
				this.Property(t => t.CHCGYQ).IsRequired().HasMaxLength(500);
				this.Property(t => t.CHCGYQZDT).IsRequired().HasMaxLength(500);
				this.Property(t => t.CHCGYQHDT).IsRequired().HasMaxLength(500);
				this.Property(t => t.GCDCXM).IsRequired().HasMaxLength(500);
				this.Property(t => t.GCDCYQ).IsRequired().HasMaxLength(500);
				this.Property(t => t.CGTSYQ).IsRequired().HasMaxLength(500);
			...
			this.Property(t => t.CHCGYQ).HasColumnName("CHCGYQ");
			this.Property(t => t.CHCGYQZDT).HasColumnName("CHCGYQZDT");
			this.Property(t => t.CHCGYQHDT).HasColumnName("CHCGYQHDT");
			this.Property(t => t.GCDCXM).HasColumnName("GCDCXM");
			this.Property(t => t.GCDCYQ).HasColumnName("GCDCYQ");
