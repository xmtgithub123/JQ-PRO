...
{
public class OaEquipRepairMap : EntityTypeConfiguration<OaEquipRepair>
    {
        public OaEquipRepairMap()
        {
			...
			this.HasRequired(t => t.FK_OaEquipRepair_EquipID).WithMany(t => t.FK_OaEquipRepair_EquipID).HasForeignKey(d => d.EquipID);
			#endregion
        }
    }
}  
