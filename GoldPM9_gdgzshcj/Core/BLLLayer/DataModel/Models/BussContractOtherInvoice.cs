...
{
    public class BussContractOtherInvoice 
    {
        public BussContractOtherInvoice()
        {
			#region DefaultValue
			Id=0;
			InvoiceDate= new DateTime(1900,1,1);
			InvoiceMoney=0;
			InvoiceNote="";
			RefID=0;
			RefTable="";
		...
		///<summary>开票/收票日期</summary>
        public DateTime InvoiceDate  { get; set; }

		///<summary>开票/收票金额(元)</summary>
		...
		///<summary>开票/收票发票类型</summary>
        public int InvoiceType  { get; set; }

		///<summary>收款/开票类型</summary>
		...
		public virtual BussContractOther FK_BussContractOtherInvoice_RefID { get; set; }
    }
}
