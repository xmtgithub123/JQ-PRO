...
{
    public class BussFeeInvoice 
    {
        public BussFeeInvoice()
        {
			#region DefaultValue
			Id=0;
		...
		public virtual BussContract FK_BussFeeInvoice_ConID { get; set; }
public virtual BusProjContractRelation FK_BussFeeInvoice_ProjID { get; set; }
    }
}
