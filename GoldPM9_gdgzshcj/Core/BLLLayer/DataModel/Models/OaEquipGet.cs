...
namespace DataModel.Models
{
    public class OaEquipGet 
    {
        public OaEquipGet()
        {
			...
			Id=0;
			EquipGetNote="";
			EquipGetApplyDate= new DateTime(1900,1,1);
			EquipGetCustomer="";
			EquipGetDate= new DateTime(1900,1,1);
			EquipGetMenoy=0;
			FlowID=0;
		...
		///<summary>设备采购备注</summary>
        public string EquipGetNote  { get; set; }

		///<summary>设备采购申请日期</summary>
        public DateTime EquipGetApplyDate  { get; set; }

		///<summary>设备采购单位</summary>
        public string EquipGetCustomer  { get; set; }

		///<summary>设备采购日期</summary>
        public DateTime EquipGetDate  { get; set; }

		///<summary>设备采购金额</summary>
        public decimal EquipGetMenoy  { get; set; }
