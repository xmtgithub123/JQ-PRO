...
{
    public class BussBiddingCost 
    {
        public BussBiddingCost()
        {
			#region DefaultValue
			Id=0;
			BussBiddingInfoID=0;
			BussBiddingInfoPackageID=0;
			TenderFee=0;
        ...
        public int BussBiddingInfoPackageID  { get; set; }
		...
		public virtual BussBiddingInfo FK_BussBiddingCost_BussBiddingInfoID { get; set; }
public virtual BussBiddingInfoPackage FK_BussBiddingCost_BussBiddingInfoPackageID { get; set; }
    }
}
