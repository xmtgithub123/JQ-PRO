...
namespace JQ.Util
{
    ...
    public abstract class TypeParse
    {
        ...
        /// 默认的日期值
        /// </summary>
        public readonly static DateTime DefaultDateTime = DateTime.Parse("1900-01-01");

        /// <summary>
        /// 获取出日期值
        /// </summary>
        /// <returns></returns>
        public static string GetDateTimeText(DateTime datetime, string format = "yyyy-MM-dd")
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetTurnedEmpIDs(string flowXml)
        {
            ...
            xmlDocument.LoadXml(flowXml);
            var xTurned = (XmlElement)xmlDocument.SelectSingleNode("Root/TurnedEmpIDs");
            if (xTurned != null)
            {
                return xTurned.InnerText;
            }
            return "";
        }
    }
